...
export function getYIDByEnrollId(empId) {
  return axios.get(`/mes/ProductionEntry/GetYIDByEnrollId?EnrollId=${empId}`);
}
...
export function getDownlloadFileView(id) {
  return axios.get(`${APIUrl}/domain/Document/DownlloadFile?id=${id}`);
}
// Api for getDownlloadFileView
...
export function createERPUserInfo(paylaod) {
  return axios.post(`/domain/CreateUser/CreateERPUserInfo`, paylaod);
}
