...
const Submissions = () => {
  ...
  useEffect(() => {
    getRowData(`/hcm/Training/GetTrainingSumissionLanding?scheduleId=${id}`);
  }, []);
            ...
            <Form className="form form-label-right">
              ...
              <div className="row">
                <div className="col-lg-12 text-center">
                  ...
                  <h3>
                    From: {_todayDate(location?.state?.fromDate)} To:{' '}
                    {_todayDate(location?.state?.toDate)}
                  </h3>
                </div>
                      ...
                      {rowData?.length > 0 &&
                        rowData?.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="text-center">
                              {item?.preAssessmentMarks}
                            </td>
                            <td className="text-center">
                              {item?.postAssessmentMarks}
                            </td>
                            <td className="text-center">
                              <IView
