...
const InvoiceReceptBluePill = ({ printRef, invoiceData }) => {
  ...
  return (
    <div className="print_invoice_wrapper_bluePill" ref={printRef}>
      <div className="header">
        ...
        <p style={{ fontSize: "40px", fontWeight: "500" }}>INVOICE</p>
        <div className="logo">
          <img
      ...
      <div className="signature_wrapper">
        <div className="first signature">
          ...
          <small>
            Goods Sold and once received or accepted by the customers <br /> are
            not returnable. Warranty will avoid of all products if sticker is
            removed
          </small>
        </div>
