...
const InvoiceReceptForPolyFibre = ({ printRef, invoiceData }) => {
  ...
  return (
    <div className="print_invoice_wrapper_poly_fibre" ref={printRef}>
      ...
      >
        <div>
          ...
          <p>
            ...
            of july, 2022, as per <br /> delivery statement enclosed, which may
            kindly by arrange for payment.
          </p>
          <br />
        </div>
        <div>
            ...
            {invoiceData?.map((item, index) => {
              ...
              return (
                <tr>
                  ...
                  <td>{item?.poNumber}</td>
                  <td>{item?.strGoodsDescription || item?.goodsDescription}</td>
                  ...
                  <td className="text-right">{_fixedPoint(item?.vatTotal)}</td>
                  <td className="text-right">
