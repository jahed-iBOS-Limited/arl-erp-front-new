        ...
        <>
          ...
          >
            <div className="row mr-2 ml-1">
              ...
              >
                <p className="pr-4">
                  <b>Disbursement Center:</b> {children?.disbursementCenterName}
                </p>
                <p className="pr-4">
                  <b>Expense Group:</b> {children?.expenseGroup}
                </p>
                <p className="pr-4">
                  ...
                  <table className="table table-striped table-bordered mt-3 bj-table bj-table-landing table-font-size-sm global-table">
                    ...
                    <tbody className="advanceInternalExp_table">
                      <tr>
                        ...
                        <td className="text-center">
                          <div className="pl-2">{children?.advanceCode}</div>
                        </td>
                        <td className="text-center">
                          <div className="pl-2">{children?.employeeId}</div>
                        </td>
                        <td className="text-left">
                          <div className="pl-2">{children?.employeeName}</div>
                        </td>
                        <td className="text-center">
                          <div className="pl-2">
