...
export default function HistoryModal({ journalId, journalTypeValue }) {
  ...
  useEffect(() => {
    ...
    if (journalId) {
      getSingleJournalData(
        `/fino/CommonFino/GetJournalViewReport?JournalId=${journalId}&AccountingJournalTypeId=${journalTypeValue}&BusinessUnitId=${selectedBusinessUnit?.value}`,
        (data) => {
          console.log('data', data);
          setSingleJournalData(data);
          getJournalHistoryData(
            `/fino/Accounting/GetAccountingJournalLOGHistory?accountingJournalId=${journalId}&accountingJournalTypeId=${journalTypeValue}`
          );
        }
      );
    }
