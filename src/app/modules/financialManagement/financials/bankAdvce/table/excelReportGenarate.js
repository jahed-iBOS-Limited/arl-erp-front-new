...
export const generateExcel = (
   ...
   if(values?.advice?.info === 'ibblBEFTN' || values?.advice?.info === 'ibbl'
   || values?.advice?.info === 'primeBEFTN' || values?.advice?.info === 'prime'
   || values?.advice?.info === 'scb' || values?.advice?.info === 'above36Character'
   || values?.advice?.info === 'below36Character' || values?.advice?.info === 'import') {
      createExcelFile(
         isHeaderNeeded,
