    ...
    const payload = {
      ...
      strRequestGlCode:
        values?.transferType?.value === 1
          ? values?.toBankName?.generalLedgerCode
          : values?.gl?.strGeneralLedgerCode || '',
    };
    onCreateHandler(
          ...
          <IForm title="Contra Create" getProps={setObjprops}>
            <Form>
              <div className="form-group global-form row">
                ...
                {[3, 4].includes(values?.transferType?.value) && (
                  <div className="col-lg-3">
                    <NewSelect
                      name="gl"
                      options={[
                ...
                <div className="col-lg-3">
                  <NewSelect
                    ...
                    onChange={(valueOption) =>
                      setFieldValue('fromBankName', valueOption)
                    }
                    errors={errors}
                    touched={touched}
                  />
                </div>
                {[2].includes(values?.transferType?.value) && (
                  <div className="col-lg-3">
                    <NewSelect
                      name="gl"
                      options={[
                  ...
                  values?.transferType?.value === 1 && (
                    <div className="col-lg-3">
                      <NewSelect
                        ...
                        onChange={(valueOption) =>
                          setFieldValue('toBankName', valueOption)
                        }
                        errors={errors}
                        touched={touched}
                      />
