            ...
            <>
              {journalData?.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="text-center">{item?.strAssetDescription}</td>
                  <td className="text-right">{item?.numSalvageValue}</td>
                  <td className="text-right">
                    {numberWithCommas(Math.round(item?.numAcquisitionValue))}
                  </td>
                  <td className="text-right">{item?.numDepRate || 0}</td>
                  <td className="text-right">
                    {numberWithCommas(Math.round(item?.numTotalDepValue))}
                  </td>
                  <td className="text-right">
