...
import { getBankAc, getCostCenterDDL, getInstrumentType, getPartnerTypeDDL, getProfitCenterDDL, getRevenueElementListDDL, getSendToGLBank } from '../../../../_helper/_commonApi';
...
export default function _Form({
  ...
  // useEffect(() => {
  //   if (initData?.partnerType?.value === 2) {
  //     getBusinessPartnerSalesDDLAction(
  //       profileData?.accountId,
  //       selectedBusinessUnit.value,
  //       setPartner
  //     );
  //   } else if (initData?.partnerType?.value === 1) {
  //     getBusinessPartnerPurchaseDDLAction(
  //       profileData?.accountId,
  //       selectedBusinessUnit.value,
  //       setPartner
  //     );
  //   } else if (initData?.partnerType?.value === 4) {
  //     getOthersPartner(
  //       profileData?.accountId,
  //       selectedBusinessUnit.value,
  //       setPartner
