...
export default function CashMarginLanding() {
   ...
   useEffect(() => {
      getRowData(`/fino/FundManagement/GetFundCashMarginPagination?businessUnitId=${selectedBusinessUnit?.value}&viewOrder=asc&pageNo=${pageNo}&pageSize=${pageSize}`);
                           ...
                           <tbody>
                              {rowData?.data?.map((item, i) => (
                                 <tr key={i}>
                                    ...
                                    <td>
                                       {_formatMoney(item?.numMarginAmount)}
                                    </td>
