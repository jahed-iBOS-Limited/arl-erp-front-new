         ...
         getByDataForCashMargin(
            ...
            data => {
               ...
               setModifyData({
                  ...
                  maturityDate: _dateFormatter(
                     cashMarginHeader?.dteMaturityDate
                  ),
               });
               ...
               {rowData?.map((item, index) => {
                  ...
                  return (
                     <tr key={index}>
                        ...
                        <td>{item?.numDepositeAmount !== 0 ? item?.numDepositeAmount : ""}</td>
                        <td>{item?.numAdjustmentAmount !== 0 ? item?.numAdjustmentAmount : ""}</td>
                        <td>{numBalance}</td>
