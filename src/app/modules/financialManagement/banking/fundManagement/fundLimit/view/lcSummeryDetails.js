...
import { getLCSummaryBasicInformation, getLCSummaryCostSummary, getShipmentListForLCSummaryReport } from '../../../../../importManagement/reports/lcSummary/helper';
                              ...
                              <table className="table table-striped table-bordered bj-table bj-table-landing">
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          {basicInformation?.incoTermsName}
                                       </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          {basicInformation?.loadingPortName}
                                       </td>
                                    </tr>
                                    <tr>
                                       <td className="text-left">
                                       ...
                                       <td>
                                          {basicInformation?.destinationPort}
                                       </td>
                                    </tr>
                                    <tr>
                                       <td className="text-left">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          {_formatMoney(
                                             basicInformation?.invoiceAmount
                                          )}
                                       </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          {
                                             basicInformation?.insuranceProviderName
                                          }
                                       </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          {basicInformation?.noOfLCAmendments}
                                       </td>
                                    </tr>
                                    <tr>
                                       <td className="text-left">
                                       ...
                                       <td>
                                          {
                                             basicInformation?.noOfInsuranceAmendments
                                          }
                                       </td>
                                    </tr>
                                 </tbody>
