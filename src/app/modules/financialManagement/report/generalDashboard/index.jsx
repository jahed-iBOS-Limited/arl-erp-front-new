    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/218e3d7e-f3ea-4f66-8150-bb16eb6fc606/reports/72ebc2de-e49a-47eb-bfcc-5f4aa497ed54`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/218e3d7e-f3ea-4f66-8150-bb16eb6fc606/reports/72ebc2de-e49a-47eb-bfcc-5f4aa497ed54/GenerateToken`,
              payload,
              configGenerateToken
            );
...
export default GeneralDashboardPBR;
