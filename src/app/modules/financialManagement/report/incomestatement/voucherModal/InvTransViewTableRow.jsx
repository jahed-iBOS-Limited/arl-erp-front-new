...
export function InvTransViewTableRow({ id, headerData }) {
  ...
  useEffect(() => {
    getCashJournalView(id, headerData?.accountingJournalTypeId, selectedBusinessUnit?.value, setCashJournalReport, setLoading);
  }, [id, headerData]);
                      ...
                      >
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="text-right pr-2">
                                    {data.debit ? _formatMoney(Math.abs(data?.debit)) : ""}
                                  </div>
                                </td>
                                <td>
                                  <div className="text-right pr-2">
                          ...
                          <tr>
                            ...
                            <td className='font-weight-bold text-center ml-1'>Total</td>
                            <td></td>
                            <td className="text-right pr-2">{_formatMoney(Math.abs(cashJournalReport?.objHeader
                              ?.numAmount))}</td>
                            <td className="text-right pr-2">{_formatMoney(Math.abs(cashJournalReport?.objHeader
                              ?.numAmount))}</td>
                          </tr>
