...
export const getIncomeStatement_api = async (
   ...
   setLoading(true);
   try {
      const res = await Axios.get(`/fino/IncomeStatement/GetIncomeStatementTaxMgt?partName=${partName}&dteFromDate=${fromDate}&dteToDate=${toDate}&dteFromDateL=${fromDateL}&dteToDateL=${toDateL}&BusinessUnitGroup=${edLabel}&BusinessUnitId=${buId}&SBUID=${sbuId || 
