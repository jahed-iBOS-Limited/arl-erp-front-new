...
const ResponsibilityCenterwisePerformanceReportRDLC = () => {
    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/218e3d7e-f3ea-4f66-8150-bb16eb6fc606/reports/f2ce0805-f365-41bf-b9bc-205afd32365e`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/218e3d7e-f3ea-4f66-8150-bb16eb6fc606/reports/f2ce0805-f365-41bf-b9bc-205afd32365e/GenerateToken`,
              payload,
              configGenerateToken
            );
      ...
      <Formik enableReinitialize={true} initialValues={initData}>
        {({ values, errors, touched, setFieldValue }) => (
          <>
            <Card>
              <ModalProgressBar />
              <CardHeader title="Responsibility Centerwise Performance Report"></CardHeader>
              <CardBody>
...
export default ResponsibilityCenterwisePerformanceReportRDLC;
