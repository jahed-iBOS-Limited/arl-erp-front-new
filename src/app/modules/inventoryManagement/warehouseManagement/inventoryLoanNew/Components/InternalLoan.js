    ...
    const saveHandler = (values, cb) => {
        if (transactionType === 1) {
            ...
            const payload = {
                ...
                // loanTypeId: loanType,
                // loanTypeName: loanType === 1 ? "Internal Loan" : "External Loan",
                // transTypeId: transactionType,
                // transTypeName: transactionType === 1 ? "Issue" : "Receive",
                ...
                // itemQty: +values?.quantity,
                // remarks: values?.remarks,
                // actionBy: profileData?.userId,
                // fromOrToBusinessUnitId: values?.toBusinessUnit?.value,
                // fromOrToBusinessUnitName: values?.toBusinessUnit?.label,
