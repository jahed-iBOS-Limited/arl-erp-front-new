...
export const saveInventoryTransactionOrder =
  (payload, setRowDto, setDisabled, setFileObjects, IConfirmModal) =>
  async (dispatch) => {
    setDisabled(true);
    try {
...
export const saveInventoryTransactionForCancelInv =
  (payload, setRowDto, setTransaType, setDisabled) => () => {
    setDisabled(true);
    return requestFromServer
...
export const getreferenceNoDDLAction =
  (refTNm, accId, buId, sbuId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getreferenceNoReceiveInvDDLAction =
  (refId, refTNm, accId, buId, sbuId, plId, whId, setFieldValue) =>
  (dispatch) => {
    return requestFromServer
      .getreferenceNoReceiveInvDDL(
        refId,
        refTNm,
        accId,
        buId,
...
export const getreferenceNoForTransferInInvDDLAction =
  (refId, accId, buId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getreferenceNoDDLActionforIssue =
  (refId, refTNm, accId, buId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getreferenceNoDDLActionforreturnDeleviry =
  (refId, refTNm, accId, buId, sbuId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getreferenceNoDDLActionforCancelInv =
  (rfId, refTNm, accId, buId, sbuId, plId, whId) => (dispatch) => {
    return requestFromServer
      .getreferenceNoDDLForCancelInv(
        rfId,
        refTNm,
        accId,
        buId,
...
export const getTransactionTypeDDLAction =
  (GrpId, refTId, setFieldValue) => (dispatch) => {
    return requestFromServer
      .getTransactionTypeDDL(GrpId, refTId)
      .then((res) => {
        const { status, data } = res;
        if (status === 200 && data) {
          if (setFieldValue) {
...
export const getItemAdjustInvDDLAction =
  (accId, buId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getItemDDLForWithoutRefAction =
  (accId, buId, plId, whId) => (dispatch) => {
    return requestFromServer.getItemDDL(accId, buId, plId, whId).then((res) => {
      const { status, data } = res;
      if (status === 200 && data) {
...
export const getItemDDLForInternalInvAction =
  (accId, buId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getItemDDLForWithoutRefReceiveInvAction =
  (accId, buId, plId, whId, prId) => (dispatch) => {
    return requestFromServer
...
export const getLocationTypeDDLAction =
  (accId, buId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getLocationTypeDDLActionForInternalInv =
  (accId, buId, plId, whId, itemId, locId) => (dispatch) => {
    return requestFromServer
...
export const getItemforCancelInvAction =
  (refId, refName, refNo) => (dispatch) => {
    return requestFromServer
...
export const getItemforReceiveInvAction =
  (refId, refName, refNo) => (dispatch) => {
    return requestFromServer
...
export const getItemforReceiveInvForeignPOAction =
  (acId, buId, poId, shipId) => (dispatch) => {
    return requestFromServer
...
export const getItemforReleaseInv =
  (accId, buId, refId, sbuId, plId, whId) => (dispatch) => {
    return requestFromServer
...
export const getItemforRemoveInv =
  (accId, buId, plId, whId, transName) => (dispatch) => {
    return requestFromServer
...
export const getItemforTransferInv =
  (accId, buId, fromplId, fromwhId, toPlId, toWhId) => (dispatch) => {
    return requestFromServer
...
export const getSingleDataForShowAction =
  (accId, buId, sbuId, plId, wrId, id) => (dispatch) => {
    return requestFromServer
      ...
      .then((res) => {
        ...
        if (status === 200 && data) {
          let newData = data.filter(
            (data) => data.inventoryTransactionId === id
          );
