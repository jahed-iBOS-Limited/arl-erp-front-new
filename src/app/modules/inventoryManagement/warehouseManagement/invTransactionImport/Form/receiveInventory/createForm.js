...
export default function ReceiveInvCreateForm({
  ...
  useEffect(() => {
    ...
    dispatch(getreferenceTypeDDLAction(1));
    // dispatch(
  ...
  //     );
  //   }
  //   dispatch(getTransactionTypeDDLAction(1, refTyp?.value, setFieldValue));
          ...
          const payload = {
            objHeader: {
              ...
              transactionGroupName:
                landingData?.transGrup?.label || "Receive Inventory",
              ...
              lighterVessel: values?.lighterVessel || "",
              motherVessel: values?.motherVessel || "",
              surveyNo: values?.surveyNo || "",
              surveyQty: values?.surveyQty || "",
            },
