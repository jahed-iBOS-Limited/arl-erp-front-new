...
import { CancelDocumentAction, serviceReceiveAttachment_action, getAttachmentLandingData, saveAttchmentForPo } from "../helper/Actions";
...
export default function ViewForm({
  ...
  let cb = () => {
    getAttachmentLandingData(poData?.serviceId, setAttchmentData)
  }
  ...
  const saveHandler = () => {
    serviceReceiveAttachment_action(fileObjects).then((data) => {
      const payload = {
        referenceId: poData?.serviceId,
        referenceCode: poData?.serviceCode,
