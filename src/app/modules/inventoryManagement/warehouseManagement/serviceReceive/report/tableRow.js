                  ...
                  <div ref={printRef} className='print_wrapper'>
                    <div className='m-3'>
                      ...
                      <div className='my-3'>
                        ...
                        <sapn className='font-weight-bold mr-2 ml-1'>
                          {serviceReport?.objHeader
                            ?.adjustmentJournalCode ? serviceReport?.objHeader
                      ...
                      <div className='my-1'>
                        ...
                        <sapn className='font-weight-bold mr-2 ml-1'>
                          {serviceReport?.objHeader
                            ?.challan ? serviceReport?.objHeader
                            ?.challan : "NA"}
                        </sapn>
                        Challan Date:
                        <sapn className='font-weight-bold mr-2 ml-1'>
                          {serviceReport?.objHeader
                            ?.challanDateTime ? _dateFormatter(serviceReport?.objHeader
                            ?.challanDateTime) : "NA"}
                        </sapn>
                        Vat Challan:
                        <sapn className='font-weight-bold mr-2 ml-1'>
                          {serviceReport?.objHeader
                            ?.vatChallan ? serviceReport?.objHeader
                            ?.vatChallan : "NA"}
                        </sapn>
                        Vat Amount:
                        <sapn className='font-weight-bold mr-2 ml-1'>
                          {serviceReport?.objHeader
                            ?.vatAmount ? serviceReport?.objHeader
                            ?.vatAmount : 0}
                        </sapn>
                        Others Charge:
                        <sapn className='font-weight-bold mr-2 ml-1'>
                        ...
                        <sapn className='font-weight-bold mr-2 ml-1'>
                          {serviceReport?.objHeader
                            ?.gateEntryNo ? serviceReport?.objHeader
                            ?.gateEntryNo : "NA"}
                        </sapn>
                        {serviceReport?.objHeader
                          ?.documentId &&
                        ...
                        <sapn className='font-weight-bold mr-2 ml-1'>
                              ...
                              title="Attachment"
                                clickHandler={() => {
                                  dispatch(
                                    getDownlloadFileView_Action(serviceReport?.objHeader
                                      ?.documentId)
                                  );
                                }
                                }
