...
export default function ItemWiseSerialEdit() {
   ...
   useEffect(() => {
      ...
      getChallanNoDDL(`/wms/ItemWiseSerialUpdate/GetChallanListDDL?BusinessUnitId=${selectedBusinessUnit?.value}`)
                                                   ...
                                                   onChange={valueOption => {
                                                      rowDtoHandler(
                                                         ...
                                                         index,
                                                         {
                                                            ...
                                                            salesOrderCode:valueOption?.salesOrderCode,
                                                            salesOrderDate:valueOption?.salesOrderDate,
