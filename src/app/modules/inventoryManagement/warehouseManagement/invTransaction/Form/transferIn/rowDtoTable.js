          ...
          <table className="table table-striped table-bordered inv-table">
            <thead>
              <tr>
                ...
                <th>Current Stock</th>
                <th>Location</th>
                {values.refType.label !== "NA (Without Reference)" && <th>Ref Qty</th>}
                {values.refType.label !== "NA (Without Reference)" && <th>Rest Qty</th>}
                {/* <th>Stock Type</th> */}
            ...
            <tbody>
              {rowDto?.map((item, index) => (
                <tr key={index}>
                  ...
                  {values.refType.label !== "NA (Without Reference)" && <td className="text-center align-middle">
                  {item?.refQty}
                  </td> }
                  {values.refType.label !== "NA (Without Reference)" && <td className="text-center align-middle">
                  {item?.restQty}
                  ...
                  <td style={{ width: "100px" }} className="disabled-feedback disable-border">
                    <IInput
                      ...
                      step="any"
                      min={0.1}
                      max={values.refType.label === "NA (Without Reference)" ? item?.availableStock : item?.restQty}
                    />
                  </td>
                  <td className="text-center align-middle">
