            ...
            <tbody>
              {rowDto?.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="text-center align-middle"> {item?.secondRefereneceCode} </td>
                  ...
                  <td className="text-center align-middle"> {item?.receiveQty} </td>
                  <td className="text-center align-middle"> {item?.restQty} </td>
