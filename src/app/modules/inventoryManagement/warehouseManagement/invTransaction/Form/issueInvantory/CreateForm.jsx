  ...
  const addRowDtoData = (values) => {
    if (values.isAllItem === false) {
      ...
      if (data) {
        ...
        getCurrentRateList(
          `/wms/InventoryLoan/GetMultipleItemRatesByIds?ItemIds=${values?.item?.value}&BusinessUnitId=${selectedBusinessUnit?.value}`,
          (currentRateList) => {
            setRowDto([
              ...rowDto,
              {
                ...
                availableStock:
                  values?.item?.locationBasedStock[0]?.currentStock,
        ...
        const payload = {
          objHeader: {
            ...
            costElementName:
              ...
              0 /* I didn't know why bind the values?.costElement?.value here for costElementName field. I was adding just || 0 for validation discased with backend dev*/,
                  ...
                  <>
                    <div className="col-lg-2">
                      <ISelect
                        ...
                        setFieldValue={setFieldValue}
                        isDisabled={
                          isProjectIdExist ? true : values.refType === ''
                        }
                        errors={errors}
                        touched={touched}
                      />
