              ...
              >
                <thead>
                  <tr>
                    ...
                    {reportTypeId === 2 && (
                      <th style={{ minWidth: '120px' }}>Current Stage</th>
                    )}
                    ...
                    <th>Order No.</th>
                    {reportTypeId === 2 && (
                      <th style={{ minWidth: '120px' }}>DO Code</th>
                    )}
                    {reportTypeId === 2 && (
                      <th style={{ minWidth: '120px' }}>Shipment Code</th>
                    )}
                  ...
                  {gridData?.map((item, index) => {
                    ...
                    return (
                      <tr key={index}>
                        ...
                        {buUnId === 144 && (
                          <td className="text-right">{numOrderQuantityTon}</td>
                        )}
                        <td className="text-right">{pendingQty}</td>
                        {buUnId === 144 && (
                          <td className="text-right">{pendingQtyTon}</td>
                        )}
                        {reportTypeId === 2 && buUnId === 144 && (
                          <td className="text-right">{deliveryQuantity}</td>
                        )}
                        {reportTypeId === 2 && buUnId === 144 && (
                          <td className="text-right">{deliveryQuantityTon}</td>
                        )}
                        <td></td>
