...
const PartnerModal = ({ tableItem, landingValues }) => {
  ...
  useEffect(() => {
    if (selectedBusinessUnit && landingValues) {
      partnerGeneralLedgerList(selectedBusinessUnit?.value, landingValues?.partnerType?.value, setGlDDL)
    }
                  ...
                  {rowDto?.length > 0 && (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <h3 className="m-0">{landingValues?.partnerType?.label} Ledger</h3>
                        <p className="m-0">
