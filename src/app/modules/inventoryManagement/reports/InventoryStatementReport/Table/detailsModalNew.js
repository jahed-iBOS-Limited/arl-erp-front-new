            ...
            <div className="inventoryStatement-reports mt-6 " ref={printRef}>
                ...
                <div>
                    <h6 className="text-center">
                        ...
                        <span className="ml-2">UOM: {type === 5 ? tableItem?.strBaseUOM : tableItem?.strUomName}</span>
                    </h6>
                </div>
                ...
                <table id="inventory-ledger-reports" className="table table-striped table-bordered global-table">
                    <thead>
                        <tr>
                            <th>SL</th>
                            ...
                            return (
                                <>
                                    <tr>
                                        ...
                                        <td className="text-right">{(item?.issueOrreceivedQty)?.toFixed(4)}</td>
