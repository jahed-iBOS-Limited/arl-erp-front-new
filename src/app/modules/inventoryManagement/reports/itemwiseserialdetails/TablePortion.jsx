          ...
          <tbody>
            {data?.map((item, i) => (
              <tr key={i}>
                ...
                <td className="text-center align-middle">
                  {' '}
                  {_dateFormatter(item?.purchaseOrderDate) || 'N/A'}
                </td>
                <td className="text-center align-middle">
                  {' '}
                ...
                <td className="text-center align-middle">
                  {' '}
                  {_dateFormatter(item?.purchaseReceiveDate) || 'N/A'}
                </td>
                <td className="text-center align-middle">
                  {' '}
                  {item?.purchaseReceiveCode || 'N/A'}{' '}
                </td>
                <td className="text-center align-middle">
                  {' '}
                  {_dateFormatter(item?.deliverydate) || 'N/A'}
                </td>
                <td className="text-center align-middle">
                  {' '}
                  {item?.deliveryCode || 'N/A'}
                </td>
                <td className="text-center align-middle">
                  {' '}
