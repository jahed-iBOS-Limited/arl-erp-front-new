  ...
  useEffect(() => {
    if (loanSingleData) {
      const newRowData = {
        ...
        shipPoint: {
          value: loanSingleData?.shipmentId,
          label: loanSingleData?.shipmentName,
        },
        lcNo: { value: loanSingleData?.lcid, label: loanSingleData?.lcnumber },
        warehouse: {
          value: loanSingleData?.wareHouseId,
          label: loanSingleData?.wareHouseName,
        },
        ...
        item: {
          value: loanSingleData?.itemId,
          label: loanSingleData?.itemName,
        },
