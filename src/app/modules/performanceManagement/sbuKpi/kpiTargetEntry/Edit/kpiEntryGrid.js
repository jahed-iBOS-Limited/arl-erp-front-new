          ...
          {strategicParticularsGrid &&
            strategicParticularsGrid?.map((itm, idx) => (
              <tr key={idx}>
                ...
                <td className="text-center disabled-feedback disable-border">
                  <IInput
                    key={itm.id}
                    type="number"
                    min="0"
                ...
                <td className="text-center">
                  <IInput
                    ...
                    name="previousYearTarget"
                    onChange={(e) =>
                      rowDtoHandler("previousYearTarget", e.target.value, idx)
                    }
                    value={objRowTargetAchivment?.[idx]?.previousYearTarget}
                  />
                </td>
              </tr>
            ))}
