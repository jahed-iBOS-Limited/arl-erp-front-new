...
import PrevTargetAchTable from "./PrevTargetAchTable";
    ...
    <div>
      <Formik
        ...
        onSubmit={(values, { setSubmitting, resetForm }) => {
          saveHandler(values, () => {
            resetForm(initData);
            history.push("/performance-management/sbu-kpi/achievement");
                        ...
                        {target?.objRow &&
                          target.objRow.map((itm, index) => (
                            ...
                            >
                              <IInput
                                value={
                                  !rowDto?.[index]?.dontsShowPlaceHolder
                                    ? itm?.achivment
                                    : rowDto?.[index]?.numAchivment
                                }
                                type="number"
                                name="numAchivment"
                                step="any"
                        ...
                        {target?.objRow &&
                          target.objRow.map((itm, index) => (
                            ...
                            >
                              <TextArea
                                value={
                                  !rowDto?.[index]?.dontsRemarksShowPlaceHolder
                                    ? itm?.remarks
                                    : rowDto?.[index]?.remarks
                                }
                                name="remarks"
                                rows="1"
                                onKeyDown={(e) => {
