      ...
      yesAlertFunc: async () => {
        const cb = () => {
          getStrategicDataAction(
            ...
            4,
            values?.corporateDepartment?.value,
            ...
            <Form className="form form-label-right">
              ...
              <div className="form-group row global-form">
                <div className="col-lg-3">
                  <NewSelect
                    label="Select Corporate Department"
                    placeholder="Select Corporate Department"
                    name="corporateDepartment"
                    options={corporateDDL}
                    value={values?.corporateDepartment}
                    onChange={(valueOption) => {
                      setFieldValue("corporateDepartment", valueOption);
                    }}
                    errors={errors}
                    touched={touched}
                  />
                      ...
                      {finance?.length > 0 && (
                        <CommonTrForInitiative
                          obj={{
                            ...
                            typeId: 4,
                            typeName: "Corporate",
                            refId: values?.corporateDepartment?.value,
                            refName: values?.corporateDepartment?.label,
                            modalHeading: "Corporate Initiative Report",
                            finance,
                            customer,
                            process,
                            growth,
