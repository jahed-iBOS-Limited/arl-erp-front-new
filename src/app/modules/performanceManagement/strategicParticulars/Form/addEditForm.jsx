      ...
      if (strId) {
        ...
        const objHeader = {
          ...
          strategicParticularsTypeId:
            +header.strategicParticularType?.value || 0,
          ...
          corporateDepartmentId: header?.isForCorporate
            ? header?.department?.value || 0
            : 0,
        ...
        const objHeader = {
          ...
          strategicParticularsTypeName:
            header.strategicParticularType?.label || '',
          parentId: header.forObjective?.value || 0,
          parentName: header.forObjective?.label || '',
          bscperspectiveId: header.bscperspective?.value || 0,
        ...
        if (
          header.isForEmployee ||
          header.isForSbu ||
          header.isForDepartment ||
          header?.isForCorporate
        ) {
          if (header.isForDepartment === true && !header.department?.value) {
            toast.warning('Please select department', { toastId: 'depError' });
          } else if (header.isForSbu === true && !header.sbu?.value) {
