...
export const GetKpiLandingReportActions = async (
  ddlName,
  buId,
  ddlValue,
  yearId,
  ...
  try {
    const res = await Axios.get(
      `/pms/Kpi2/GetKpiLandingReport?businessUnitId=${buId}&searchDDL=${ddlName}&searchValue=${ddlValue}&isDashBoard=false&yearId=${yearId}&fromMonthId=${fromMonthId || 13}&toMonthId=${toMonthId || 24}&isPIPReport=false`
    );
