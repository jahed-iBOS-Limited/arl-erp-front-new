  ...
  const saveHandler = (values, cb) => {
    ...
    const payload = {
      ...
      arrivalDateTime:
        ...
        new Date(),
      ...(values?.berthDate && {
        berthDate: moment(values?.berthDate).format('YYYY-MM-DDTHH:mm:ss'),
      }),
      ...(values?.cutOffDate && {
        cutOffDate: moment(values?.cutOffDate).format('YYYY-MM-DDTHH:mm:ss'),
      }),
      ...(values?.estimatedTimeOfDepart && {
        estimatedTimeOfDepart: moment(values?.estimatedTimeOfDepart).format(
          'YYYY-MM-DDTHH:mm:ss',
        ),
      }),
          ...
          <>
            <Form className="form form-label-right">
              ...
              <div className="form-group row global-form">
                ...
                <div className="col-lg-3">
                  <InputField
                    value={values?.stuffingDate}
                    label="Estimated Pickup Date"
                    name="stuffingDate"
                    type="date"
                    onChange={(e) =>
                      setFieldValue('stuffingDate', e.target.value)
                    }
                  />
                </div>
                {/* Vehicle info */}
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    name="berthDate"
                    type="date"
                    onChange={(e) => setFieldValue('berthDate', e.target.value)}
                  />
                </div>
                {/* CutOffDate */}
                <div className="col-lg-3">
                ...
                <div className="form-group row global-form">
                  ...
                  <div className="col-lg-2">
                    <InputField
                      ...
                      name="cbm"
                      type="number"
                      onChange={(e) => setFieldValue('cbm', e.target.value)}
                    />
                  </div>
                  ...
                  <div className="col-lg-2">
                    <InputField
                      ...
                      name="kgs"
                      type="number"
                      onChange={(e) => setFieldValue('kgs', e.target.value)}
                    />
                  </div>
                  <div className="col-lg-2 pt-4">
                    <button
                      onClick={() => {
                        if (
                          !formikRef.current?.values?.containerNumber ||
                          !formikRef.current?.values?.sealNumber ||
                          !formikRef.current?.values?.size ||
                          !formikRef.current?.values?.quantity ||
                          !formikRef.current?.values?.cbm ||
                          !formikRef.current?.values?.kgs
                        ) {
              ...
              {/* items table */}
              <div className="pt-4">
                {formikRef.current?.values?.items.length > 0 && (
