                              ...
                              onClick={() => {
                                ...
                                containerDesc.push({
                                  ...
                                  sealNumber:
                                    formikRef.current?.values?.rows?.[index]
                                      ?.sealNumber,
                                  size: formikRef.current?.values?.rows?.[index]
                                    ?.size?.label,
                                  quantity:
                                    formikRef.current?.values?.rows?.[index]
                                      ?.quantity,
                                  rate: formikRef.current?.values?.rows?.[index]
                                    ?.rate,
                                  cbm: formikRef.current?.values?.rows?.[index]
                                    ?.cbm,
                                  kgs: formikRef.current?.values?.rows?.[index]
                                    ?.kgs,
                                });
                                setFieldValue(
