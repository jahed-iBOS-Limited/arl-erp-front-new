...
import "../style.css";
import FinalInvoiceChartererView from "./finalInvoiceChartererView";
...
function FinalInvoiceCharterer({
  invoiceHireData,
  formikprops,
  rowData,
  setRowData,
      ...
      >
        ...
        <div style={{margin: "0 30px"}}>
          <h5
            ...
            className="text-center mb-4 uppercase statementTitle"
          >
        ...
        ${_dateFormatter(invoiceHireData?.cpDate)}`}
          ...
          <div className="row">
            ...
            <div className="col-lg-12 headerWrapper mb-2">
              <div className="headerKey">REFERENCE :</div>
              <div className="headerValue">
                {`${values?.vesselName?.label} CP Date
        ${_dateFormatter(invoiceHireData?.cpDate)}`}
              </div>
            </div>
                  ...
                  <tbody>
                    {rowData?.map((item, index) => (
                      <tr key={index}>
                        ...
                        {/* Debit is Credit For Final Invoice */}
                        ...
                        {/* Credit is Debit For Final Invoice */}
                        <td style={{ width: "130px" }} className={`text-right`}>
                          <>
...
export default FinalInvoiceCharterer;
