...
export default function ServicePO({
  ...
  const [, postUpdateExpense] = useAxiosPost();
  const [transferUnitSupplierDDL, getTransferUnitSupplierDDL, , ,] =
    useAxiosGet();
  ...
  const { currencyDDL, paymentTermsDDL, incoTermsDDL, uomDDL, profileData } =
    storeData;
