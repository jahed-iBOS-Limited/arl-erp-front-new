...
export const validationSchema = Yup.object().shape({
  ...
  numTropicalLightShipMts: Yup.number().when('isEditing', {
    is: false,
    then: Yup.number().required('Tropical Light Ship (Mts) is required'),
    else: Yup.number(),
  }),
  intHoldNumber: Yup.number().when('isEditing', {
    is: false,
