            ...
            <tbody>
              ...
              {rowDto?.data?.map((tableData, index) => (
                <tr key={index}>
                    ...
                    <div class="order-md-3 p-1">
                      ...
                      >
                        <input
                          ...
                          checked={
                            tableData?.employeeRemunerationSetupRowStatus
                          }
                  ...
                  <td>
                    <div className="d-flex justify-content-around baiscInfo_table">
                      <button
                        ...
                        onClick={() => {
                          history.push({
                            pathname: `/human-capital-management/humanresource/other-info/edit/${tableData?.employeeId}`,
                            state: tableData,
                          });
                        }}
                      >
