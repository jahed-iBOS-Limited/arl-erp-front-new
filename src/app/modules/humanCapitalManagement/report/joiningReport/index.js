    ...
    <>
      ...
      >
        {({ values, errors, touched, setFieldValue }) => (
          <>
            <ICard printTitle="Print" title="Employee Joining Report Monthly" isPrint={true} isShowPrintBtn={true} componentRef={printRef}>
                        ...
                        <div className="row">
                          ...
                          <div style={{ marginTop: "15px" }} className="col-lg-4 d-flex">
                            <button
                              ...
                              onClick={() => {
                                getEmployeeJoiningConfirmationReport(3, values?.startDate, values?.endDate, setRowDto, setLoading);
                              }}
                      ...
                      {rowDto?.length > 0 &&
                        rowDto?.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td>{item?.strEmail === "00" ? "" : item?.strEmail}</td>
...
export default EmpJoiningReport;
