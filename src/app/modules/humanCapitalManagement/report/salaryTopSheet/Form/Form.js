...
import { getWorkplaceGroupDDL } from "../../empOverallStatus/helper";
...
export default function _Form({ initData, btnRef, resetBtnRef }) {
  ...
  const openNewWindowForDetails = (reportType, item, values) => {
    ...
    window.open(
      "/human-capital-management/Report/salary-top-sheet/details",
      "_blank"
    );
  };
                  ...
                  <div className="loan-scrollable-table employee-overall-status salaryTopSheet">
                    ...
                    >
                      <div ref={printRef}>
                        ...
                        >
                          <h4>Salary Top Sheet Summary</h4>
                          ...
                          <tbody>
                            {reports?.map((item, index) => (
                              <tr key={index}>
                                ...
                                <td><span>{item?.strWorkplaceGroupName}</span></td>
                                <td><span>{item?.strWorkplaceGroupName}</span></td>
