...
const DetailsTable = () => {
  ...
  const {
    ...
    return state.localStorage?.salaryTopSheetDetails;
  }, shallowEqual);
  ...
  return (
    <>
      <ICustomCard title="Salary Top Sheet Details">
        <div className="text-right">
          <button
            ...
            onClick={(e) =>
              downloadFile(
                `/hcm/HCMReport/GetSalaryTopSheetReportDetailsDownload?reportTypeId=${reportType}&businessUnitId=${buId}&workPlaceGroupId=${workPlaceGroupId}&positionGroupId=${positionGrpId}&monthId=${monthId}&yearId=${yearId}`,
                "Salary Top Sheet Details",
                "xlsx"
              )
            }
          >
            ...
            <table className="table table-striped table-bordered bj-table bj-table-landing">
              <thead>
                <tr>
                  ...
                  <th style={{ minWidth: "90px" }}>Leave Deduct Days</th>
                  ...
                  <th style={{ minWidth: "70px" }}>Pay In Cash</th>
              ...
              <tbody>
                {gridData?.map((item) => (
                  <tr>
                    ...
                    <td className="text-center">{item?.intSPL || 0}</td>
                    <td className="text-center">{item?.intLWP}</td>
                    <td className="text-center">{item?.intLate}</td>
                    <td className="text-center">{item?.intLeaveDeductDays || 0}</td>
