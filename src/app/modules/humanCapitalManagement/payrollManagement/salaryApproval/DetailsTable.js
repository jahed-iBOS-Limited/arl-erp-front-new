...
const SalaryApprovalDetailsTable = () => {
  ...
  return (
    <>
      <ICustomCard title="Salary Approval Details">
            ...
            <table className="table table-striped table-bordered bj-table bj-table-landing">
              <thead>
                <tr>
                  ...
                  <th style={{ minWidth: "120px" }}>Job Station/Sub Child Category</th>
                  <th>Unit</th>
...
export default SalaryApprovalDetailsTable;
