...
export function TableRow({ saveHandler }) {
  ...
  const leaveApplicationPublic = userRole.filter(
    (item) => item?.strFeatureName === "Leave/Movement Application(Public)"
  );
  ...
  const singleLeaveRemoveHandler = (index) => {
    if (index && profileData?.accountId && selectedBusinessUnit?.value) {
      ...
      let confirmObject = {
        ...
        noAlertFunc: () => {
          history.push(
            "/human-capital-management/leavemovement/leavemovemententry"
          );
        },
      };
                  ...
                  <div className="row bank-journal bank-journal-custom bj-left">
                    <div className="col-lg-12 d-flex mb-2">
                      <div className="mt-5">
                        ...
                        {leaveApplicationPublic[0]?.isCreate === true ? (
                          <label>
                            <input
                              type="radio"
                              name="privacyType"
                        ...
                        <div style={{ width: "300px" }} className="ml-2">
                          ...
                          <SearchAsyncSelect
                            ...
                            handleChange={(valueOption) => {
                              ...
                              getEmpInfoById(valueOption, setFieldValue, "employee")
                              setRowDto([]);
                              setRowDtoTwo([]);
                            }}
                      ...
                      <div style={{ marginTop: "16px" }} className="ml-2">
                        <ButtonStyleOne
                          ...
                          onClick={() => {
                            history.push({
                              pathname:
                                "/human-capital-management/leavemovement/leavemovemententry/add",
                              state: {
