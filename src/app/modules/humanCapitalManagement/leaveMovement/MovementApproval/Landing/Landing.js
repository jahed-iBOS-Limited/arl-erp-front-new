...
const MovementApprovalLanding = () => {
  ...
  // const singleLeaveApproveHandler = (
  //   index,
  //   applicationId,
  //   UserID,
  //   Approved,
  ...
  //     title: "Are you sure?",
  //     yesAlertFunc: async () => {
  //       movementApproveAction(applicationId, UserID, Approved, Rejected, () => {
  //         getNewApplicationData(
  ...
  //     noAlertFunc: () => {
  //       history.push(
  //         "/human-capital-management/leavemovement/movementapproval"
  //       );
  //     },
  //   };
                  ...
                  <div className="col-lg-12">
                    <div className="global-form">
                      <div className="row">
                        ...
                        <div style={{ marginTop: "14px" }} className="col-lg-1">
                          <button
                            type="button"
