...
export function getGridData(
  ...
  return axios.get(
    `/oms/Shipment/GetShipmentPasignation?AccountId=${accId}&BUnitId=${buId}&ShipmentId=${ShipmentId}&ReportType=${reportTypeId}&FromDate=${fromDate}&Todate=${toDate}&viewOrder=desc&PageNo=${pageNo}&PageSize=${pageSize}`
  );
}
...
export function getIncompleteGridData(
  ...
  return axios.get(
    `/tms/Shipment/ShipmentLandingPagination?AccountId=${accId}&BusinessUnitId=${buId}&ShipPointId=${ShipmentId}&date=${tillDate}&viewOrder=desc&PageNo=${pageNo}&PageSize=${pageSize}`
  );
}
