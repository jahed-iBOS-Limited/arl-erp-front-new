...
export const GetVehicleDDLAction =
  (accId, buId, setvehicleDDLLoding) => (dispatch) => {
...
export const getDeliveryeDatabyId =
  (deliveryId, values, buId, setCostlaborRateStatus, setLoading) =>
  (dispatch) => {
...
export const getSalesContactIncompleteGridData =
  (accId, buId, ShipmentId, tillDate, search, setLoading, pageNo, pageSize) =>
  (dispatch) => {
    setLoading(true);
    return requestFromServer
...
export const getStockStatusOnShipmentAction =
  (deliveryId, buId, setLoadingTwo) => (dispatch) => {
