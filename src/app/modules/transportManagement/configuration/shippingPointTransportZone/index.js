...
export default function ShippingPointTransportZoneLanding() {
    ...
    const landingData = (values) => {
        getRowData(
            `/oms/POSDamageEntry/GetWareHouseZoneLandingPagination?accountId=${profileData?.accountId
    ...
    const confirmToCancel = (id, values) => {
        let confirmObject = {
            ...
            yesAlertFunc: async () => {
                ...
                getDeleteData(`/oms/POSDamageEntry/DeleteWareHouseZone?UserId=${profileData?.userId
                    }&BusinessUnitId=${selectedBusinessUnit?.value
                    }&AutoId=${id
                    }`, cb);
            },
                            ...
                            return (
                                <div>
                                    <button
                                        ...
                                        onClick={() => {
                                            history.push("/transport-management/configuration/shippingpointtransportzone/create");
                                        }}
                                    >
                                        Create
                                    </button>
