                          ...
                          <div className="col-lg-2 mb-2">
                            <button
                              onClick={() => {
                                let objDDL = {
                                  value: 0,
                                  label: `${values?.vehicleCity?.label} ${values?.vehicleRegistrationLetter?.label} ${values?.vehicleRegistrationNumber?.label}-${values?.vehicleManualNo}`,
                                };
                                setNewValues({
                                  ...newValues,
                                  vehicleNo: objDDL,
                              ...
                              disabled={
                                !values?.vehicleCity ||
                                !values?.vehicleRegistrationLetter ||
                                !values?.vehicleRegistrationNumber ||
                                !values?.vehicleManualNo
                              }
                              type="button"
                            >
                              Add
