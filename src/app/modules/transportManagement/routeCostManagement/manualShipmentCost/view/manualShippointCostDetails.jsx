...
export function ManualShippointCostDetails({
  currentItem,
  isHiddenBackBtn,
  valuesfordate,
}) {
  const [manualShippointCostDetails, getManualShippointCostDetails] =
    useAxiosGet();
  ...
  useEffect(() => {
    getManualShippointCostDetails(
      `/tms/ShipmentStandardCost/ManualShipmentCostDetails?accountId=${
        profileData?.accountId
      }&businessUnitId=${
        selectedBusinessUnit?.value
      }&shipPointId=${shippointId}&FromDate=${
                              ...
                              (data, i) => (
                                <>
                                  <tr key={i}>
                                    ...
                                    <td className="">{data?.billSubmitBy}</td>
