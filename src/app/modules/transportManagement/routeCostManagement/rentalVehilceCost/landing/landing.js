                              ...
                              {values?.itemLists?.map((data, index) => {
                                ...
                                return (
                                  <tr key={index}>
                                    ...
                                    <td>{data?.soldToPartnerName}</td>
                                    <td>
                                      {_dateFormatter(data?.shipmentDate)}
                                    </td>
                                  ...
                                  <InputField
                                    ...
                                    name={`itemLists.${index}.additionalCost`}
                                  ...
                                  <InputField
                                    ...
                                    name={`itemLists.${index}.additionalCostReason`}
                                    placeholder="Additional Cost Reason"
                                    type="text"
                                    onChange={(e) => {
                                      setFieldValue(
                                        e.target.name,
                                  ...
                                  values?.itemLists[index]?.additionalCostReason
                                )} */}
                                      {
                                        values?.itemLists[index]
                                          ?.additionalCostReason
                                  ...
                                  <InputField
                                    ...
                                    name={`itemLists.${index}.deductionCost`}
                                  ...
                                  <InputField
                                    ...
                                    name={`itemLists.${index}.deductionCostReason`}
                                    placeholder="Deduction Cost Reason"
                                    type="text"
                                    onChange={(e) => {
                                      setFieldValue(
                                        e.target.name,
                                  ...
                                  values?.itemLists[index]?.deductionCostReason
                                )} */}
                                      {
                                        values?.itemLists[index]
                                          ?.deductionCostReason
                                      ...
                                      <div className="d-flex justify-content-between">
                                        ...
                                        {data?.isEdit && (
                                          <span
                                            onClick={(e) => {
                                              history.push({
                                                pathname: `/transport-management/routecostmanagement/rentalVehicleCost/edit/${data?.tripId}`,
                                              });
                                            }}
                                            // className="mr-2"
                                          >
...
export default RentalVehilceCostLanding;
