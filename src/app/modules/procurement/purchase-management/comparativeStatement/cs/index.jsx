...
function ShippingComparativeStatement() {
  ...
  useEffect(() => {
    getRowData(
      `/procurement/ShipRequestForQuotation/GetRFQCSLandingShipPagination?AccountId=${
                          ...
                          {rowData?.objHead?.length > 0 &&
                            rowData?.objHead?.map((item, index) => (
                              <tr key={index}>
                                ...
                                <td>{`${
                                  item?.quotationStartDateTime?.split('T')[0]
                                } / ${
                                  item?.quotationStartDateTime?.split('T')[1]
                                }`}</td>
                                <td>{`${
                                  item?.quotationEndDateTime?.split('T')[0]
                                } / ${
                                  item?.quotationEndDateTime?.split('T')[1]
                                }`}</td>
