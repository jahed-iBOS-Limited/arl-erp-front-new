                        ...
                        <div className="form-group  global-form">
                           <div className="row">
                              ...
                              <div className="col-lg-3">
                                 RFQ Date:{' '}
                                 {_dateFormatter(
                                    location?.state?.dteRfqdate ||
                                       location?.state?.rfqdate
                                 )}
                              </div>
                              <div className="col-lg-3">
                                 Currency:{' '}
                              ...
                              <div className="col-lg-3">
                                 ...
                                 {location?.state?.quotationStartDateTime
                                    ...
                                    : `${
                                         location?.state?.startDate?.split(
                                            'T'
                                         )[0]
                                      } / ${
                                         location?.state?.startDate?.split(
                              ...
                              <div className="col-lg-3">
                                 ...
                                 {location?.state?.quotationEndDateTime
                                    ? `${
                                         location?.state?.quotationEndDateTime?.split(
                                            'T'
                                         )[0]
                                      } / ${
                                         location?.state?.quotationEndDateTime?.split(
                                    ...
                                    <table 
                                       ...
                                       <thead>
                                          <tr>
                                             ...
                                             <th>Item Name</th>
                                             {csDetailsList?.objRow?.[0]?.intItemCategoryId === 624 ? 
                                                <>
                                                   <th>Part No</th>
                                                   <th>Drawing No</th>
                                                </> : null
                                       ...
                                       <tbody>
                                                      ...
                                                      {item?.objPartnerHeader?.map(
                                                         partnerData => (
                                                            <>
                                                               ...
                                                               <td>
                                                                  {partnerData?.objPartnerRow?.strRemarks ? 
                                                                     partnerData?.objPartnerRow?.strRemarks
                                                                     : ""}
                                                               </td>
                                                               <td className='text-center'>
                                                                  {partnerData?.objPartnerRow?.strAttachment ? 
                                                                     <>
                                                                        <IView
                                                                           title={'Attachment'}
                                          ...
                                          <tr>
                                             <td
                                                colSpan={csDetailsList?.objRow?.[0]?.intItemCategoryId === 624 ? 7 : 5}
                                                ...
                                                (itm, index) => (
                                                   <>
                                                      ...
                                                      >
                                                         {`${(getPercentageValue(
                                                            itm
                                                         )).toFixed(2)} (${itm?.numDiscountPercentage ||
                                                            0}%)`}
                                                      </td>
                                                      <td>{''}</td>
                                                      <td>{''}</td>
