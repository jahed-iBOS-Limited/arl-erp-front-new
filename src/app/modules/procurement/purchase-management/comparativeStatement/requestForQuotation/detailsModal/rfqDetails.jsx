                  ...
                  <div className="mx-5">
                    <div ref={printRef}>
                      ...
                      >
                        <thead className="tableHead">
                          <tr>
                            ...
                            <th>Item Code</th>
                            <th>Item Name</th>
                            {rfqDetailsData[0]?.objRow[0]?.intItemCategoryId ===
                            624 ? (
                              <>
                                <th>Part No</th>
                                <th>Drawing No</th>
                        ...
                        <tbody className="tableHead">
                          {rfqDetailsData[0]?.objRow?.map((data, i) => (
                            <>
                              {(i === 0 ||
                                data.strShippingItemSubHead !==
                                  rfqDetailsData[0]?.objRow[i - 1]
                              ...
                              <tr key={i}>
                                ...
                                <td className="">{data?.strUoMname}</td>
                                <td className="">{data?.numRfqquantity}</td>
                              </tr>
                            </>
                          ))}
                        </tbody>
                      ...
                      >
                        ...
                        <tbody className="tableHead">
                          {rfqDetailsData[0]?.objSuplier?.map((data, i) => (
                            <>
                              <tr key={i}>
                                <td className="text-center">{i + 1}</td>
                                <td>{data?.strBusinessPartnerName}</td>
                                <td>{data?.strBusinessPartnerAddress}</td>
                                <td className="">{data?.strContactNumber}</td>
                                <td>{data?.strEmail}</td>
                              </tr>
                            </>
                          ))}
                      ...
                      <div className="mt-3">
                        <small>
                          {rfqDetailsData[0]?.objHeader?.strCreatedBy
                            ? `Created By: [${
                                rfqDetailsData[0]?.objHeader?.strCreatedBy ||
                                '--'
                              }][${
                                rfqDetailsData[0]?.objHeader?.strDesignation ||
                                '--'
                              }]`
                            : ''}
                        </small>
