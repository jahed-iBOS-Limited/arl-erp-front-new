            ...
            <table className="table table-striped table-bordered mt-3 global-table po-table">
              <thead>
                <tr>
                  ...
                  <th style={{ width: '110px', fontSize: '10px' }}>Ref No.</th>
                    ...
                    <>
                      {(index === 0 ||
                        item.strShippingItemSubHead !==
                          rowDto[index - 1].strShippingItemSubHead) &&
                      item?.strShippingItemSubHead ? (
                        <tr
                          style={{
                            background: '#ADD8E6',
                        ...
                        >
                          <td
                            colSpan={
                              rowDto[0]?.intItemCategoryId === 624 ? '13' : '11'
                            }
                          >
                            <div
                              style={{ fontSize: '20' }}
                      ...
                      <tr key={index}>
                        ...
                        <td style={{ width: '100px' }}>{item?.strUoMname}</td>
