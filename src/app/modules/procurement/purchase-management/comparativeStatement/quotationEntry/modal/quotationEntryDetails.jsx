                    ...
                    >
                      ...
                      <tbody className="tableHead">
                            ...
                            <>
                              ...
                              data?.strShippingItemSubHead ? (
                                ...
                                >
                                  <td
                                    colSpan={
                                      rowDto?.objRow[0]?.intItemCategoryId ===
                                      624
                                        ? '11'
                                        : '9'
                                    }
                              ...
                              <tr key={i}>
                                ...
                                <td className="text-right">
                                  {data?.numNegotiationRate > 0
                                    ? (
                                        data?.numNegotiationRate *
                                          data?.numRfqquantity || 0
                                      ).toFixed(2)
                                    : (
                                        data?.numRate * data?.numRfqquantity ||
                                        0
                                      ).toFixed(2)}
                                </td>
                              </tr>
                        ...
                        <tr>
                          ...
                          <td className="text-right font-weight-bold ">
                            {`${getPercentageValue(
                              rowDto?.objHeader?.numDiscountPercentage,
                              subTotal
                            ).toFixed(2)} (${
                              rowDto?.objHeader?.numDiscountPercentage || 0
                            }%)`}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="text-right font-weight-bold ">
                            {rowDto?.objHeader?.numTransportCost || 0}
                          </td>
                        </tr>
                        <tr>
                          <td
                          ...
                          <td className="text-right font-weight-bold ">
                            {rowDto?.objHeader?.numOthersCost || 0}
                          </td>
                        </tr>
                        <tr>
                          <td
