...
} from '../../purchaseOrderShipping/_redux/Actions';
...
function ShippingQuotationEntry() {
  ...
  useEffect(() => {
    if (profileData?.userTypeId === 2) {
      getRowData(
        `/procurement/ShipRequestForQuotation/GetRFQEntryLandingShipPagination?AccountId=${
          profileData.accountId
        }&UnitId=${
          selectedBusinessUnit.value
  ...
  const setPositionHandler = (pageNo, pageSize, values) => {
    ...
    getRowData(
      `/procurement/ShipRequestForQuotation/GetRFQEntryLandingShipPagination?AccountId=${
        ...
        values?.sbu?.value
      }&RfqTypeId=1&PurchaseOrganizationId=${
    ...
    <>
      <Formik
        ...
        initialValues={{
          ...
          purchaseOrg: {
            value: purchaseOrgDDL[0]?.value,
            label: purchaseOrgDDL[0]?.label,
          },
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-2">
                      <button
                        ...
                        disabled={
                          profileData?.userTypeId !== 2 ? !values?.plant : false
                        }
                        onClick={() => {
                          ...
                          {rowData?.data?.length > 0 &&
                            rowData?.data?.map((item, index) => (
                              <tr key={index}>
                                ...
                                <td>{`${item?.startDate?.split('T')[0]} / ${
                                  item?.startDate?.split('T')[1]
                                }`}</td>
                                <td>{`${item?.endDate?.split('T')[0]} / ${
