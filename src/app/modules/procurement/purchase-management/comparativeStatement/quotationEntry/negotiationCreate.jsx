...
export default function ShippingNegotiationCreate() {
  ...
  const saveHandler = async (values, cb) => {
    ...
    const payload = {
      ...
      intPartnerRfqid: negotiationItemList?.objSuplierHeader?.intPartnerRfqid,
      ...
      <>
        <Formik
          ...
          initialValues={{
            ...
            supplierEmail: negotiationItemList?.objSuplierHeader?.strEmail,
            transportCost:
              negotiationItemList?.objSuplierHeader?.numTransportCost,
            othersCost: negotiationItemList?.objSuplierHeader?.numOthersCost,
            discountPercentage:
              negotiationItemList?.objSuplierHeader?.numDiscountPercentage,
            headerRemarks: negotiationItemList?.objSuplierHeader?.strRemarks,
          }}
              ...
              <Form className="form form-label-right">
                <div className="form-group  global-form">
                  <div className="row">
                    ...
                    <div className="col-lg-3">
                      Currency:{' '}
                      {negotiationItemList?.objHeader?.strCurrencyCode}
                    </div>
                    <div className="col-lg-3">
                      Delivery Address:{' '}
                      {negotiationItemList?.objHeader?.strDeliveryAddress}
                    </div>
                    <div className="col-lg-3">
