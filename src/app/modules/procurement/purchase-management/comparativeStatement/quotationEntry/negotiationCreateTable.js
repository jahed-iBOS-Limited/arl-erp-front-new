               ...
               <table className="table table-striped table-bordered mt-3 global-table po-table">
                  <thead>
                     <tr>
                        ...
                        {negotiationItemList?.objSupplierRow[0]?.intItemCategoryId === 624 ? 
                        <>
                  ...
                  <tbody>
                     {negotiationItemList?.objSupplierRow?.map(
                        (item, index) => {
                     ...
                     <tr>
                        <td
                           colSpan={negotiationItemList?.objSupplierRow[0]?.intItemCategoryId === 624 ? 11 :  9}
                        ...
                        <td
                           ...
                           style={{ fontSize: '12px' }}
                        >
                           {(getSubTotal(negotiationItemList?.objSupplierRow) || 0).toFixed(2)}
                        </td>
                        <td></td>
                        <td></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td
                           ...
                           style={{ fontSize: '12px' }}
                        >
                           {((getSubTotal(negotiationItemList?.objSupplierRow) ||
                              0) -
                              (getDiscount(
                                 getSubTotal,
                                 discountPercentage,
