            ...
            <Form>
              <div className="form-group global-form row">
                <div className="col-lg-3">
                  ...
                  <span>RFQ-1-4-20230612131817</span>
                </div>
                <div className="col-lg-3">
                ...
                <div className="col-lg-3">
                  <span className="font-weight-bold">RFQ Start Date-Time:</span>{' '}
                  <span>21-06-2023, 11:57 AM</span>
                </div>
                {/* l2 */}
                <div className="col-lg-3">
                ...
                <div className="col-lg-3">
                  <span className="font-weight-bold">Transport Cost:</span>{' '}
                  <span>Excluding</span>
                </div>
                <div className="col-lg-3">
                ...
                <div className="col-lg-3">
                  <span className="font-weight-bold">RFQ End Date-Time:</span>{' '}
                  <span>28-06-2023, 11:57 AM</span>
                </div>
                {/* l3 */}
                <div className="col-lg-3">
                  <span className="font-weight-bold">Plant:</span>{' '}
                  <span>ACCL Narayangonj</span>
                </div>
                <div className="col-lg-3">
                  <span className="font-weight-bold">Warehouse:</span>{' '}
                  <span>ACCL Factory</span>
                </div>
              </div>
              {/* supplier block */}
              <div className="form-group global-form row">
              ...
              <div className="form-group global-form row">
                <div className="col-lg-8">
                  ...
                  <span>
                    ...
                    Ipsa nesciunt porro iste, veritatis iusto deserunt
                    repudiandae dignissimos ratione voluptate aliquid, odio et
                    suscipit fuga corporis sit assumenda ullam voluptates quam
                    possimus perferendis quas? Repellendus quibusdam, provident
                    aliquid eius illo amet culpa impedit animi, aliquam,
                    reprehenderit modi ipsam officia? Inventore consequatur ea
                    aliquid nobis nam, unde alias maxime voluptatibus id
                    asperiores! Sequi nobis reiciendis ut, quos placeat sint
                    doloremque! Cum placeat voluptatibus quibusdam dicta ratione
                    omnis ex quos alias recusandae suscipit explicabo amet
                    reprehenderit eveniet ipsum nostrum aspernatur voluptas,
                    quod assumenda autem impedit minima deleniti odio a atque!
                    Dolorem, hic. Ab!
                  </span>
                </div>
