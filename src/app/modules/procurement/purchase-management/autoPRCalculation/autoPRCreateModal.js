...
export default function AutoPRCreateModal({ parentValues, callBack, setShowSaveModal }) {
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            IConfirmModal({
                                                ...
                                                yesAlertFunc: () => {
                                                    getSaveStatus(`/procurement/MRPFromProduction/IsAvailableDateForMRP?businessUnitId=${values?.businessUnit?.value}&fromDate=${values?.fromDate}`, (res) => {
                                                        if (res) {
                                                            return toast.warn("The selected date is already exists")
