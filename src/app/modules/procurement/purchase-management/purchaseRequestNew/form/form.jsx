...
export default function FormCmp({
  ...
  const [itemAvailableQty, getItemAvailableQty, , setItemAvailableQty] =
    useAxiosGet();
  useEffect(() => {
    ...
    getItemTypeList(setItemTypeDDL);
  ...
  const loadUserList = (v) => {
    ...
    const standardItemTypeId = `&itemTypeId=${selectedItemTypeId}`;
    const itemCategoryId = `&itemCategoryId=${selectedItemCategoryId}`;
    return Axios.get(
      `/wms/ItemPlantWarehouse/GetItemPlantWarehouseForPurchaseRequestSearchDDL?accountId=${
        ...
        location?.state?.plant?.value || initData?.plantId
      }&whId=${
        location?.state?.wh?.value || initData?.warehouseId
      }&purchaseOrganizationId=${
        location?.state?.po?.value || initData?.purchaseOrganizationId
      }&typeId=${itemTypeId}&searchTerm=${v}${standardItemTypeId}${itemCategoryId}`
    ).then((res) => {
              ...
              <div className="row">
                <div className="col-lg-2 global-form">
                  <div className="row">
                    ...
                    {values?.requestType?.label === 'Standard PR' ? (
                      <>
                        <div className="col-lg-12">
                          <NewSelect
                            name="itemType"
                            ...
                            onChange={(valueOption) => {
                              if (valueOption) {
                                ...
                                setSelectedItemTypeId(valueOption?.value);
                              } else {
                                setFieldValue('itemType', '');
                        ...
                        <div className="col-lg-12">
                          <NewSelect
                            ...
                            onChange={(valueOption) => {
                              ...
                              setSelectedItemCategoryId(valueOption?.value);
                              setRowDto([]);
                            }}
