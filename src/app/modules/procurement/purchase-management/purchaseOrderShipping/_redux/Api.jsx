...
export function getPOReferenceTypeDDL(orderTypeId) {
  return axios.get(
    `/procurement/PurchaseOrder/GetPOReferenceTypeShip?PoTypeId=${orderTypeId}`
    //`/procurement/PurchaseOrder/getPOReferenceType?PoTypeId=${orderTypeId}` //Previous PORefDDL API
  );
}
...
export function getStandradPOItemDDL(
 // odId,
  ...
  return axios.get(
    `/procurement/ShipRequestForQuotation/ShipPurchaseOrderRFQItemDDL?AccountId=${accId}&BusinessUnitId=${buId}&SBUId=${sbuId}&RequestForQuotationId=${refNoId}&BusinessPartnerId=${refTypeId === 4 ? partnerId : 0}&RefTypeId=${refTypeId}`
    // `/procurement/PurchaseOrderItemDDL/StandardPurchaseOrderItemList?ItemTypeId=0&OrderTypeId=${odId}&AccountId=${accId}&BusinessUnitId=${buId}&SbuId=${sbuId}&PurchaseOrgId=${purchaseOrgId}&PlantId=${plantId}&WearhouseId=${whId}&RefTypeId=${refTypeId}&RefNoId=${refNoId}` //Previous PO Item DDL
  );
}
