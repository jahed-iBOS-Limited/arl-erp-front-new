        ...
        {data?.map((td, index) => {
          return (
            <tr key={index}>
              ...
              <td> {td.isApprove ? "Approved" : td?.isClose ? "Closed" : "Pending"} </td>
              <td>
                      ...
                      {!td.isApprove && (
                        <>
                          ...
                          <span
                            onClick={() =>
                              history.push({
                                pathname: `/mngProcurement/purchase-management/shippingpurchaseorder/edit/${td?.purchaseOrderId}/${POorderType}`,
                                //  state: values,
                              })
                            }
                  ...
                  checkTwoFactorApproval(
                    ...
                    (status) => {
                      if (status === 1) {
                        ...
                        // });
                        history.push({
                          pathname: `/mngProcurement/purchase-management/shippingpurchaseorder/edit/${reverseModalShowState?.data?.purchaseOrderId}/${POorderType}`,
                          //  state: values,
                        });
                      }
                    }
