...
export function ShippingViewReport3({
  poId,
  orId,
  isHiddenBackBtn,
  setLoading,
                ...
                <div id="pdf-section">
                  <div className="mx-5">
                    <div ref={printRef}>
                                ...
                                <>
                                  {(i === 0 ||
                                    data.shippingItemSubHead !==
                                      purchaseOrderReport?.objRowListDTO[i - 1]
                                        .shippingItemSubHead) &&
                                  data?.shippingItemSubHead ? (
                                    <tr
                                      style={{
                      ...
                      <div className="mt-3">
                        <p>
                          Note: 1) All materials must be asbestos-free.
                          <br />{' '}
                          <span className="pl-5 ml-5">
                            2) Payment will be made in full only upon complete
                            satisfaction of respective HOD.
                          </span>
                        </p>
