...
export function ShippingViewReport3({ poId, orId, isHiddenBackBtn, setLoading }) {
                        ...
                        <div id="pdf-section">
                           <div className="mx-5">
                              <div ref={printRef}>
                                    ...
                                    <tbody className="tableHead">
                                       ...
                                       <tr>
                                          <td
                                             ...
                                             style={{ fontSize: '12px' }}
                                          >
                                             {`Discount (${purchaseOrderReport?.objHeaderDTO?.discountPercentage || 0}%)`}
                                          </td>
                                          <td
                                             className="text-right font-weight-bold "
                                             style={{ fontSize: '12px' }}
                                 ...
                                 <div className="mt-3">
                                    <p>
                                       Note: 1) All materials must be
                                       asbestos-free.
                                       <br />{' '}
                                       <span className="pl-5 ml-5">
                                          2) Payment will be made in full only
                                          upon complete satisfaction of
                                          respective HOD.
                                       </span>
                                    </p>
                                    ...
                                    >
                                       THIS IS A SYSTEM GENERATED PURCHASE
                                       ORDER, HENCE NO SIGNATURE IS REQUIRED
                                    </p>
                                 </div>
                                 ...
                                 >
                                    <div>
                                       Corporate Office: Akij House, 198, Bir
                                       Uttam Mir Shawkat Ali Road, Tejgaon I/A,
                                       Dhaka -1208, Phone: +880 1671 595899,
                                       +880 9613311021, E-mail:
                                       shipping@akij.net
                                    </div>
                                    <div className="px-2">
                                       <hr
                                    ...
                                    <div>
                                       Chattogram Office: 3rd Floor, Shahjadi
                                       Chamber 1331/S Sk. Mujib Road Agrabad,
                                       Chattogram, Phone: +880 1711 338613,
                                       E-mail: agency.asll@akij.net
                                    </div>
                                 </div>
                              </div>
                           </div>
