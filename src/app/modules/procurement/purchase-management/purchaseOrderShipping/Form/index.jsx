      ...
      if (
        ...
        const payload = {
          objHeaderDTO: {
            ...
            transferBusinessUnitId: values?.isTransfer
              ? values?.transferBusinessUnit?.value || 0
              : 0,
            transferCostElementId: values?.isTransfer
              ? values?.costElement?.value || 0
              : 0,
            transferCostCenterId: values?.isTransfer
