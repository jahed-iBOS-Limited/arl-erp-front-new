...
import { getReportPurchaseOrder, getReportPurchaseOrderForShipping } from "../helper";
...
export function ShippingViewReport3({ poId, orId, isHiddenBackBtn }) {
                  ...
                  <div className="mx-5">
                    <div ref={printRef}>
                      ...
                      <h3 className="pt-3 pb-1 text-center">
                        WE ARE PLEASED TO APPOINT YOU FOR SHIP’S SIDE CHIPPING PAINTING JOB OF {purchaseOrderReport?.objHeaderDTO?.plantName}
                      </h3>
                      <table
                      ...
                      >
                        <thead className="tableHead">
                          <tr>
                            <th>SL</th>
                            <th>Description with Specification</th>
                            <th>QTY</th>
                            <th>UNIT</th>
                            <th>UNIT USD</th>
                            <th>TOTAL USD</th>
                      ...
                      <div className="mt-3">
                        <p>
                          Note: 1) Payment will be made only upon onboard Master & C/O’s satisfaction.<br />{" "}
                          <span className="pl-5 ml-5">
                            2) Payment will be made only upon onboard Master & C/O’s satisfaction.
                          </span>
                        </p>
