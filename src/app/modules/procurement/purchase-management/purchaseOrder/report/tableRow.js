                  ...
                  <div className="mx-5">
                    <div ref={printRef}>
                      ...
                      <div className="my-2">
                        ...
                        <b>Warehouse: </b>
                        <span className="mr-2">
                          {purchaseOrderReport?.objHeaderDTO?.warehouseName}
                        </span>
                      </div>
                      <div className="parchaseReport">
                        <div className="reportInfo">
                          <div className="reportInfo1">
                            ...
                            <p>
                              Attn:{" "}
                              {purchaseOrderReport?.objHeaderDTO?.strPropitor}
                            </p>
                            <p>
                              Phone:{" "}
                              {
                          ...
                          <div className="reportInfo2">
                            ...
                            <p>
                              ...
                              >
                                {purchaseOrderReport?.objHeaderDTO?.prNo}
                              </span>
                            </p>
                            <p
                              style={{
                            ...
                            >
                              {" "}
                              Bank Name:{" "}
                              {purchaseOrderReport?.objHeaderDTO?.bankName ||
                                ""}
                            </p>
                            <p>
                              {" "}
                              Account Name:{" "}
                              {purchaseOrderReport?.objHeaderDTO?.accountName ||
                                ""}
                            </p>
                          </div>
                          <div className="reportInfo3">
                            ...
                            <p>
                              {" "}
                              Account No:{" "}
                              {purchaseOrderReport?.objHeaderDTO?.accountNo ||
                                ""}
                            </p>
                            <p>
                              {" "}
                      ...
                      <div className="mt-3">
                        <p className="text-uppercase font-weight-bold">
                          Total (In Word): {amountToWords(grandTotal)}{" "}
                          {formValues?.purchaseOrg?.value === 12
                            ? purchaseOrderReport?.objHeaderDTO?.currencyCode
                            : "TK"}{" "}
                          only
                        </p>
