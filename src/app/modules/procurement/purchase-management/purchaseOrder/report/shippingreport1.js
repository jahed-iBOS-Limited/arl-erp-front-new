...
export function ShippingViewReport1({ poId, orId, isHiddenBackBtn }) {
                  ...
                  <div className="mx-5">
                    <div ref={printRef}>
                      ...
                      <h3 className="pt-3 pb-1 text-center">
                        WE APPROVE SUPPLY OF BELOW AE TC SPARES FOR {purchaseOrderReport?.objHeaderDTO?.plantName}
                      </h3>
                      <table
                      ...
                      <div className="mt-3 fixed">
                        ...
                        <h3
                          className="text-uppercase font-weight-bold text-center fixed-signature"
