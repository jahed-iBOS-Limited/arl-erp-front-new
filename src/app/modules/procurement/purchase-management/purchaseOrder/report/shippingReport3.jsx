...
import {
  ...
  getReportPurchaseOrderForShipping,
} from '../helper';
                  ...
                  <div className="mx-5">
                    <div ref={printRef}>
                      ...
                      >
                        ...
                        <tbody className="tableHead">
                          ...
                          <tr>
                            ...
                            <td>
                              {purchaseOrderReport?.objHeaderDTO?.leadDays}
                            </td>
                      ...
                      <h3 className="pt-3 pb-1 text-center">
                        WE ARE PLEASED TO APPOINT YOU FOR SHIP’S SIDE CHIPPING
                        PAINTING JOB OF{' '}
                        {purchaseOrderReport?.objHeaderDTO?.plantName}
                      </h3>
                      <table
                      ...
                      <div className="mt-3">
                        <p>
                          Note: 1) Payment will be made only upon onboard Master
                          & C/O’s satisfaction.
                          <br />{' '}
                          <span className="pl-5 ml-5">
                            2) Payment will be made only upon onboard Master &
                            C/O’s satisfaction.
                          </span>
                        </p>
