...
import { getRefNoDdlFoAssetPo } from "../../Form/assetPoForm/helper";
...
export default function AssetPOEditForm({
  btnRef,
  saveHandler,
  resetBtnRef,
  disableHandler,
                ...
                <div className="form-group row">
                    ...
                    item.type === 1 ? (
                      <div key={index} className="col-lg-2">
                        <ISelect
                          ...
                          name={item.name}
                          isDisabled={viewPage || item?.name === "incoterms"}
                          setFieldValue={setFieldValue}
                          errors={errors}
                          touched={touched}
                        />
                  ...
                  <div className="col-lg-2">
                    {values?.supplierName?.label && (
                      <div style={{ marginTop: "23px", color: "blue" }}>
