                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td className="text-right">
                          <span>
                            {numberWithCommas(
                              (item?.valueAdjustInventory || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        <td className="text-right">
                        ...
                        <td className="text-right">
                          <span>
                            {numberWithCommas(
                              (item?.valueIssueReturn || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        {/* <td className="text-right">
                        ...
                        <td className="text-right">
                          <span className="pl-2">
                            {numberWithCommas(
                              (item?.valueReceiveInventory || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        <td className="text-right">
                        ...
                        <td className="text-right">
                          <span className="pl-2">
                            {numberWithCommas(
                              (item?.valueReceivedFromProduction || 0).toFixed(
                                2
                              )
                            )}
                          </span>
                        ...
                        <td className="text-right">
                          <span className="pl-2">
                            {numberWithCommas(
                              (item?.valueIssueInventory || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        <td className="text-right">
                        ...
                        <td className="text-right">
                          <span className="pl-2">
                            {numberWithCommas(
                              (item?.valuePurchaseReturn || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        <td className="text-right">
                        ...
                        <td className="text-right">
                          <span className="pl-2">
                            {numberWithCommas(
                              (item?.valueTransferIn || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        <td className="text-right">
                        ...
                        <td className="text-right">
                          <span className="pl-2">
                            {numberWithCommas(
                              (item?.valueTransferOut || 0).toFixed(2)
                            )}
                          </span>
                        </td>
                        <td className="text-right">
