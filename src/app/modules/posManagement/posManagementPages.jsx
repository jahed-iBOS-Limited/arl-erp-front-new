  ...
  return (
    <Suspense fallback={<LayoutSplashScreen />}>
      <Switch>
        ...
        />
        <ContentRoute path="/pos-management/report" component={ReportPages} />
        <ContentRoute
          path="/pos-management/configuration"
          component={ConfigurationPages}
        />
        <ContentRoute path="/pos-management/damage" component={DamagePages} />
        <ContentRoute
          path="/pos-management/configuration"
          component={ConfigurationPages}
        />
        <ContentRoute path="/pos-management/event" component={AelEventPages} />
      </Switch>
    </Suspense>
  );
}
