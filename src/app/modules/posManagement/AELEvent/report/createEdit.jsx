...
const AelReportCreate = () => {
  ...
  const saveHandler = async (values, cb) => {
    if (
      values?.strCluster.value !== '' &&
      values?.intEmployeeId !== '' &&
      values?.strEmployeeName !== '' &&
      values?.strDesignationName &&
      values?.strDepartmentName !== '' &&
      values?.strMobile !== ''
    ) {
      saveData(
                      ...
                      {values?.strCluster.value === 4 && (
                        ...
                        >
                          <i
                            ...
                            onClick={() => {
                              getData(
                                `/hcm/EmployeeBasicInformation/GetEmployeeInformation?EmployeeId=${values?.intEmployeeId}`,
                                (data) => {
                                  setFieldValue(
                                    'strEmployeeName',
                                    data[0]?.strEmployeeFullName
                                  );
                                  setFieldValue(
                                    'strDesignationName',
                                  ...
                                  setFieldValue(
                                    'strMobile',
                                    data[0]?.employeeContactNo
                                  );
                                  setFieldValue(
                                    'intDesignationId',
                                    data[0]?.intDesignationId
                                  );
                                  setFieldValue(
                                    'intDepartmentId',
                                    data[0]?.intDepartmentId
                                  );
                                }
                              );
                            }}
