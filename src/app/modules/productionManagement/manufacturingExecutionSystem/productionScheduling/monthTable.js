...
const MonthTable = ({ tableData, setTableData, singleData, cb, values }) => {
  ...
  const totalQuantity = tableData[singleData?.productIndex]?.workCenters[
    singleData?.workCenterIndex
  ]?.dailySchedules.reduce((total, schedule) => {
  ...
  const hasValidData =
    ...
    tableData[singleData.productIndex]?.workCenters[singleData.workCenterIndex]
      ...
      <div className="d-flex justify-content-around">
        <div>
          <p>
            ...
            {tableData[singleData?.productIndex]?.productName}
          </p>
        </div>
        <div>
          <p>
            <strong>Month: </strong> {values?.month?.label}
          </p>
        </div>
        {/* <div>
        ...
        <div>
          <p>
            <strong>Year: </strong> {values?.year?.label}
          </p>
        </div>
      </div>
      {loading && <Loading />}
        ...
        <>
          <div className="table-responsive">
            <table className="table table-bordered">
              ...
              <tbody>
                {tableData[singleData.productIndex]?.workCenters[
                  singleData.workCenterIndex
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <InputField
                        value={day.quantity}
                        onChange={(e) =>
                          handleQuantityChange(day.scheduleDate, e.target.value)
                        }
                      />
                    </td>
                  </tr>
                ...
                <tr>
                  ...
                  <td className="">
                    <span className="pl-4">{totalQuantity}</span>
                  </td>
                </tr>
              </tbody>
            </table>
