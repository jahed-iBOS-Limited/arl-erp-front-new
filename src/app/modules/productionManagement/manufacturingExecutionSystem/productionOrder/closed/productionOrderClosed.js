...
export default function ProductionOrderClosed() {
   ...
   return (
      <IForm title="Production Order Closed" getProps={setObjprops} submitBtnText="Closed">
         {false && <Loading />}
         <>
            <Formik
                              ...
                              <table className="table table-striped table-bordered mt-3 bj-table bj-table-landing">
                                 <thead>
                                    <tr>
                                       ...
                                       <th className='' style={{width:"140px"}}>Return Quantity</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    {productionOrderList?.materialList?.length >
                                       0 &&
                                       productionOrderList?.materialList?.map(
                                          (item, index) => (
                                             <tr key={index}>
                                                ...
                                                >
                                                   <IInput
                                                      value={productionOrderList?.materialList[index]?.returnQuantity}
                                                      name="returnQuantity"
                                                      type="tel"
                                                      min="0"
