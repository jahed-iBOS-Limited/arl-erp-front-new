...
export default function _Form({
  ...
  useEffect(() => {
      if(initData?.plantName?.value){
        getwareHouseDDL(`/wms/BusinessUnitPlant/GetOrganizationalUnitUserPermissionforWearhouse?UserId=${profileData?.userId}&AccId=${profileData?.accountId}&BusinessUnitId=${selectedBusinessUnit?.value}&PlantId=${initData?.plantName?.value}&OrgUnitTypeId=8`)
      }
