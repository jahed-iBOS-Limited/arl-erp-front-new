...
export function TableRow({ dataForBackCalculationCheck }) {
  ...
  const setPositionHandler = (pageNo, pageSize, searchValue) => {
    if(!selectPlant || !selectedDDLShop ) return toast.warn("Please select plant and shop floor")
    getGridData(
      profileData?.accountId,
      selectedBusinessUnit?.value,
      selectPlant?.value,
                  ...
                  <td>
                    ...
                    <div className="text-center">
                            ...
                            {item?.productionOrderCode ? (<span
                              ...
                              </span>) : (<span>{item?.productionCode || ""}</span>)}
                          </div>
                  </td>
                  ...
                  <td>
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <button class="btn borderlessBtn">
                          <span className="text-center mx-2">
                            <IView
                              clickHandler={() => {
                                if (
                                  dataForBackCalculationCheck?.isBackCalculation === 1
                                ) {
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (dataForBackCalculationCheck?.isBackCalculation === 1) {
                            history.push(
