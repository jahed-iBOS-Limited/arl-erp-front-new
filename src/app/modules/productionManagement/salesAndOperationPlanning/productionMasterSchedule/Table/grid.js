...
import { getMasterSchedulingLandingPageData, updateMasterScheduling } from '../helper'
...
const GridData = ({ gridData, loading, plant, year, horizon, setGridData }) => {
  ...
  const updateItemQuantity=()=>{
    ...
    if(rowIndex && itemQuantity){
      updateData.push({
        productionMasterScheduleId: gridData[rowIndex-1].productionMasterScheduleId,
        productionMasterScheduleRowId: gridData[rowIndex-1].productionMasterScheduleRowId,
