...
export default function MoistureReportLanding() {
    ...
    const [moistureData, getMoustureData, moistureDataLoader, setMoustureData] = useAxiosGet()
    ...
    const getLandingData = (values, pageNo, pageSize) => {
        getMoustureData(`/hcm/QCTest/MoistureTransactionQcTestLanding?BusinessUnitId=${selectedBusinessUnit?.value}&FromDate=${values?.fromDate}&Todate=${values?.toDate}&PageNo=${pageNo}&PageSize=${pageSize}`)
    };
                ...
                <>
                            ...
                            return (
                                <div>
                                    <button
                                        ...
                                        onClick={() => {
                                            history.push("/production-management/ACCLFactory/moistureTest/report");
                                        }}
                                    >
                                        Report View
                                    </button>
                                    <button
                                        ...
                                        onClick={() => {
                                            history.push("/production-management/ACCLFactory/moistureTest/create");
                                        }}
                                    >
                                        Create
                                    </button>
                    ...
                    >
                        <Form>
                            <div>
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                            ...
                                            <tbody>
                                                {
                                                    ...
                                                    moistureData?.data?.data?.map((item, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="text-center">{item?.shiftName}</td>
                                                            <td>{item?.comments}</td>
                                                            <td style={{
                                        ...
                                        {moistureData?.data?.data?.length > 0 ? <PaginationTable
                            ...
                            >
                                <MoistureDataView viewShift={viewShift} viewDate={viewDate} viewRemarks={viewRemarks}/>
                            </IViewModal>
                        </Form>
                    </IForm>
