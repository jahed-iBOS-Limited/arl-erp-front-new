...
export default function MoistureDataView({ viewShift, viewDate, viewRemarks }) {
    ...
    useEffect(() => {
        if (viewShift && viewDate) {
            ...
            getItemData(`/hcm/QCTest/GetMoistureQCItemConfigData?Date=${_dateFormatter(viewDate)}&Shift=${viewShift}&BusinessUnitId=${selectedBusinessUnit?.value}`,
                (data) => {
            ...
            {({
                ...
                <>
                    ...
                    <IForm
                        ...
                        isHiddenBack
                        isHiddenSave
                        title={"View Moisture Data"} getProps={setObjprops}>
                        <Form>
