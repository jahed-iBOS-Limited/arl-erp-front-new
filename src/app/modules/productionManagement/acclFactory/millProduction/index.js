...
export default function MillProduction() {
    ...
    const [millProductionlanding, getMillProductionlanding, loaderMillProductionlanding] = useAxiosGet();
    ...
    const setPositionHandler = (pageNo, pageSize, values) => {
        getMillProductionlanding(`/mes/MSIL/GetAllMillProductionLanding?BusinessunitId=${selectedBusinessUnit?.value}&Fromdate=${values?.fromDate}&Todate=${values?.toDate}&PageNo=${pageNo}&PageSize=${pageSize}`)
    }

    useEffect(() => {
        getMillProductionlanding(`/mes/MSIL/GetAllMillProductionLanding?BusinessunitId=${selectedBusinessUnit?.value}&Fromdate=${initData?.fromDate}&Todate=${initData?.toDate}&PageNo=${pageNo}&PageSize=${pageSize}`)
                            ...
                            return (
                                <div>
                                    <button
                                        ...
                                        onClick={() => {
                                            history.push("/production-management/ACCLFactory/mill-production/create");
                                        }}
                                    >
                                        Create
                                    </button>
                            ...
                            <div className="form-group row global-form">
                                ...
                                <div className="col-lg-2">
                                    <button
                                        ...
                                        className="btn btn-primary"
                                        onClick={() => {
                                            getMillProductionlanding(`/mes/MSIL/GetAllMillProductionLanding?BusinessunitId=4&Fromdate=${values?.fromDate}&Todate=${values?.toDate}&PageNo=${pageNo}&PageSize=${pageSize}`)
                                        }}
                                    >
                                        Show
                                    </button>
