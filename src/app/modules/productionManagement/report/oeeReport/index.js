    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/b6ecbdf2-74c0-4290-97d0-13e617fd474e/reports/f5b5ac3d-14aa-4e28-844c-9d94e53881c5`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/b6ecbdf2-74c0-4290-97d0-13e617fd474e/reports/f5b5ac3d-14aa-4e28-844c-9d94e53881c5/GenerateToken`,
              payload,
              configGenerateToken
            );
      ...
      <Formik enableReinitialize={true} initialValues={initData}>
        {({ values, errors, touched, setFieldValue }) => (
          <>
            <Card>
              <ModalProgressBar />
              <CardHeader title="OEE REPORT"></CardHeader>
              <CardBody>
