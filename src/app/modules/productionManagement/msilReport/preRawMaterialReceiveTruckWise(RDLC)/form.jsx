...
const PreRawMaterialReceiveTruckWiseReportRDLC = () => {
    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/e3ce45bb-e65e-43d7-9ad1-4aa4b958b29a/reports/0d864d11-8d61-418c-b39d-ee72fc673611`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/e3ce45bb-e65e-43d7-9ad1-4aa4b958b29a/reports/0d864d11-8d61-418c-b39d-ee72fc673611/GenerateToken`,
              payload,
              configGenerateToken
            );
      ...
      <Formik enableReinitialize={true} initialValues={initData}>
        {({ values, errors, touched, setFieldValue }) => (
          <>
            <Card>
              <ModalProgressBar />
              <CardHeader title="Pre Raw Material Receive"></CardHeader>
              <CardBody>
...
export default PreRawMaterialReceiveTruckWiseReportRDLC;
