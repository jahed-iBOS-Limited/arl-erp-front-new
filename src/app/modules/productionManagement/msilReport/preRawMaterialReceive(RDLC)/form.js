...
const PreRawMaterialReceiveReportRDLC = () => {
    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/e3ce45bb-e65e-43d7-9ad1-4aa4b958b29a/reports/0bca4425-6d7f-4bf3-9efc-38b523891c25`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/e3ce45bb-e65e-43d7-9ad1-4aa4b958b29a/reports/0bca4425-6d7f-4bf3-9efc-38b523891c25/GenerateToken`,
              payload,
              configGenerateToken
            );
...
export default PreRawMaterialReceiveReportRDLC;
