    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/e3ce45bb-e65e-43d7-9ad1-4aa4b958b29a/reports/800f8d33-8ac1-41b1-8d03-b3d47a667d51`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/e3ce45bb-e65e-43d7-9ad1-4aa4b958b29a/reports/800f8d33-8ac1-41b1-8d03-b3d47a667d51/GenerateToken`,
              payload,
              configGenerateToken
            );
      ...
      <Formik enableReinitialize={true} initialValues={initData}>
        {({ values, errors, touched, setFieldValue }) => (
          <>
            <Card>
              <ModalProgressBar />
              <CardHeader title="Breakdown Report"></CardHeader>
              <CardBody>
...
export default BreakDownReportRDLC;
