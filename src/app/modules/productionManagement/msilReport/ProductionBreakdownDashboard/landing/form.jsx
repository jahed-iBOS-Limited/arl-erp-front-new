...
const ProductionBreakdownReport = () => {
    ...
    getRowData(url, async (data) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://api.powerbi.com/v1.0/myorg/groups/b6ecbdf2-74c0-4290-97d0-13e617fd474e/reports/d7ecebe8-6ca0-4cd1-a92b-871d04b4bd41`,
          config
        );
        if (res?.data) {
          ...
          try {
            ...
            const resGenerateToken = await axios.post(
              `https://api.powerbi.com/v1.0/myorg/groups/b6ecbdf2-74c0-4290-97d0-13e617fd474e/reports/d7ecebe8-6ca0-4cd1-a92b-871d04b4bd41/GenerateToken`,
              payload,
              configGenerateToken
            );
      ...
      <Formik enableReinitialize={true} initialValues={initData}>
        {({ values, errors, touched, setFieldValue }) => (
          <>
            <Card>
              <ModalProgressBar />
              <CardHeader title="Production Breakdown Dashboard Report"></CardHeader>
              <CardBody>
...
export default ProductionBreakdownReport;
