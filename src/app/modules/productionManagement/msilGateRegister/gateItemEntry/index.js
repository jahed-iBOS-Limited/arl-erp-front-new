                ...
                <div className="row global-form">
                  ...
                  <div>
                    <button
                      ...
                      disabled={!values?.businessUnit || !values?.shipPoint || !values?.date}
                      onClick={(e) => {
                        landingData(values)
                      }}
                    >
                        ...
                        {rowData?.data?.length > 0 &&
                          rowData?.data?.map((item, index) => (
                            <tr key={index}>
                              ...
                              <td className="text-center">{item?.strTruckNumber}</td>
                              <td className="text-center">
                                {item?.strEntryCode}
                              </td>
                              <td className="text-center">
                              ...
                              <td className="text-center">{item?.strInvoiceNumber}</td>
                              {selectedBusinessUnit?.value === 4 ? (
                              ...
                              {isBulkEdit?.isEdit &&
                                <>
                                  {item?.isBulk === null ?
                                    <td className="text-center">
                                      <OverlayTrigger overlay={<Tooltip id="cs-icon">{"Bulk"}</Tooltip>}>
                                        <span>
                                          <i
                                            style={{ fontSize: "18px" }}
                                    ...
                                    :
                                    <td className="text-center">{item?.isBulk ? "Yes" : "No"}</td>
                                  }
                                </>
                              }
