...
function SecurityPostAssignDetailsView({shiftList}) {
  ...
  useEffect(() => {
    getRowData(
      `/mes/MSIL/GetSecurityPostAssignListByDateShift?date=${_dateFormatter(shiftList?.dteDate)}&ShiftId=${shiftList?.intShiftId}&BusinessunitId=${selectedBusinessUnit?.value}`
    );
        ...
        {({ values }) => (
          <>
            <Card>
              ...
              <CardHeader title={"Security Post Assign Details"}>
