                                                ...
                                                {landigData?.data?.length > 0 &&
                                                    landigData?.data?.map((item, index) => (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="text-center">{item?.numPreviousReading}</td>
                                                            <td className="text-center">{item?.numPresentReading}</td>
                                                            <td className="text-center">{item?.numGasConsumption}</td>
                                                            <td className="text-center">{item?.numTotalGeneration}</td>
                                                            <td className="text-center">{item?.numGasConsumptionPerUnit?.toFixed(2)}</td>
