  ...
  const saveHandler = async (values, cb) => {
    saveData(
      `/mes/MSIL/CreateEditElectricalGeneratorRunningHour`,
      {
        ...
        tmStartTime: params?.id ? values?.startTime : `${values?.startTime}:00`,
        ...
        numGeneration:
          selectedBusinessUnit?.value === 4
            ...
            : 0,
        numPreviousReading:
          selectedBusinessUnit?.value === 4 ? values?.numPreviousReading : 0,
        numPresentReading:
          selectedBusinessUnit?.value === 4 ? values?.numPresentReading : 0,
