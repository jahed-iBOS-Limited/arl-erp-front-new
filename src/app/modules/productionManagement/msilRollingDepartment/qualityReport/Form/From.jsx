...
export default function QualityReportForm({
  ...
  const actualAreaFunction = (data) => {
    return (
      (Math.sqrt(data * 162.196) * Math.sqrt(data * 162.196) * 3.14) /
      4
    ).toFixed(6);
  };
              ...
              <div className="form-group row global-form">
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="time"
                    onChange={(e) => {
                      setFieldValue('physicalTestTime', e.target.value);
                    }}
                  />
                </div>
                <div className="col-lg-3">
                  <NewSelect
                    ...
                    options={[
                      ...
                      {
                        value: 'Akij Ispat B500DWR',
                        label: 'Akij Ispat B500DWR',
                      },
                      {
                        value: 'Akij Ispat B420DWR',
                        label: 'Akij Ispat B420DWR',
                      },
                    ]}
                    value={values?.grade}
                    label="Grade"
                  ...
                  <InputField
                    ...
                    onChange={(e) => {
                      if (e.target.value) {
                        ...
                        setFieldValue(
                          'numActualDia',
                          actualDiaFunction(e.target.value)
                        );
                        setFieldValue(
                          'numActualArea',
                          actualAreaFunction(e.target.value)
                        );
                      } else {
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numEmfpercentage', e.target.value);
                    }}
                    min={0}
                    max={100}
                  />
                    ...
                    onChange={(e) => {
                      if (e.target.value) {
                        ...
                        setFieldValue(
                          'numYieldStrengthCal',
                          (
                            (e.target.value / values?.numActualArea) *
                            1000
                          ).toFixed(6)
                        );
                      } else {
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numYieldStrengthCal', e.target.value);
                    }}
                    min={0}
                    disabled
                  />
                    ...
                    onChange={(e) => {
                      if (e.target.value) {
                        ...
                        setFieldValue(
                          'numTsYsratioCal',
                          (
                            ((e.target.value / values?.numActualArea) * 1000) /
                            values?.numYieldStrengthCal
                          ).toFixed(6)
                        );
                      } else {
                        setFieldValue('numMaximumForce', '');
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numTensileStrengthCal', e.target.value);
                    }}
                    min={0}
                    disabled
                  />
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numRuptureLoad', e.target.value);
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numTsYsratioCal', e.target.value);
                    }}
                    min={0}
                    disabled
                  />
                ...
                <div className="col-lg-3">
                  <NewSelect
                    ...
                    onChange={(valueOption) => {
                      setFieldValue('strNatureOfBillet', valueOption);
                    }}
                    errors={errors}
                    touched={touched}
                  />
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numBilletTempreture', e.target.value);
                    }}
                    min={0}
                  />
                </div>
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numFurnaceTempreture', e.target.value);
                    }}
                    min={0}
                  />
                </div>
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numTmtwaterTempreture', e.target.value);
                    }}
                    min={0}
                  />
                </div>
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numBarEntryTempreture', e.target.value);
                    }}
                    min={0}
                  />
                </div>
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numBarExitTempreture', e.target.value);
                    }}
                    min={0}
                  />
                </div>
                ...
                <div className="col-lg-3">
                  <InputField
                    ...
                    type="number"
                    onChange={(e) => {
                      setFieldValue('numWaterPressure', e.target.value);
                    }}
                    min={0}
                  />
                </div>
