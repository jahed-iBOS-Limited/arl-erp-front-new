...
import { CardBody, CardHeader, CardHeaderToolbar, ModalProgressBar, Card } from "../../../../../_metronic/_partials/controls";
...
export default function MedicalStock() {
  ...
  const setPositionHandler = (pageNo, pageSize, values, searchValue = "") => {
    getRowData(`/mes/MSIL/GetMedicalStockLanding?BuId=${selectedBusinessUnit?.value}&PageNo=${pageNo}&PageSize=${pageSize}`);
  };
