...
const ExpenseRegisterLanding = () => {
  ...
  useEffect(() => {
    ...
    if (personalExpRegLanding?.internalAccount) {
      expenseForDDLFunc(true);
    } else {
      expenseForDDLFunc(false);
    }
        ...
        {({ errors, touched, setFieldValue, isValid, values }) => (
          <>
            <Card>
              ...
              <CardHeader title={"TADA Application"}>
                <CardHeaderToolbar>
                  <button
                    onClick={() => {
                      dispatch(setPersonalExpRegLandingAction(values));
                      history.push({
                        pathname: "/self-service/tada-application/create",
                        state: {
                                  ...
                                  <div className="d-flex justify-content-around">
                                    <span className="view">
                                      <IView
                                        clickHandler={() =>
                                          history.push({
                                            pathname: `/self-service/tada-application/view/${item?.expenseId}`,
                                            state: {
                                              item,
                                              selectedExpense:
                                                values?.expenseFor,
                                    ...
                                    <span
                                      ...
                                      onClick={() => {
                                        history.push({
                                          pathname: `/self-service/tada-application/edit/${item?.expenseId}`,
                                          state: {
                                            item,
                                            ...values,
                                            selectedExpense: values?.expenseFor,
                                      ...
                                      item?.isApprovedPermit && (
                                        <span
                                          onClick={() => {
                                            ...
                                            history.push({
                                              pathname: `/self-service/tada-application/approval/${item?.expenseId}`,
                                              state: {
                                                item,
                                                ...values,
                                                selectedExpense:
