...
export default function RoasterSetup({ basicDataSave }) {
  ...
  const saveHandler = async (values, cb) => {
    ...
    if (!basicDataSave?.joiningDate)
      return toast.warn('Joining date not found in employee basic info');

    if (values?.generateDate < basicDataSave?.joiningDate)
      return toast.warn('Can not generate roster before joining date');
