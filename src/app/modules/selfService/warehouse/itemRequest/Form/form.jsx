  ...
  const loadUserList = (v, resolve) => {
    ...
    return Axios.get(
      itemType === 1
        ...
        : itemType === 2
          ? `/wms/ItemRequestDDL/GetItemForServiceTypeDDL?AccountId=${accountId}&BusinessUnitId=${selectedBusinessUnit?.value}&PlantId=${plantId || initData?.intPlantId}&WarehouseId=${whId || initData?.intWarehouseId}&searchTerm=${v}`
          : itemType === 3
            ? `/wms/ItemRequestDDL/GetItemForOthersTypeDDL?AccountId=${accountId}&BusinessUnitId=${selectedBusinessUnit?.value}&PlantId=${plantId || initData?.intPlantId}&WarehouseId=${whId || initData?.intWarehouseId}&searchTerm=${v}`
            : ''
    ).then((res) => {
