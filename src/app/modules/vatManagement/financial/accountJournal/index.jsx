...
const AccountJournal = () => {
  ...
  const createTransferJournelToTaxAccConfirmation = (values) => {
    let confirmObject = {
      ...
      yesAlertFunc: () => {
        createTransferJournelToTaxAcc(
          `/fino/TransferJournalToTaxAcc/CreateTransferJournalToTaxAcc?BusinessUnitId=${selectedBusinessUnit?.value}&ActionById=${profileData?.userId}`,
          [
            {
                    ...
                    <div className="d-flex align-items-end pt-1">
                      ...
                      <div className=" d-flex justify-content-end align-items-center ">
                        <button
                          ...
                          onClick={() => {
                            getGridData(values, pageNo, pageSize);
                            dispatch(SetAccountingJournalLandingAction(values));
                          }}
