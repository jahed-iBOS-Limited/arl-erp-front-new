    ...
    <div>
              ...
              <td className="text-center">
                <div className="d-flex align-items-center justify-content-center">
                  ...
                  <span
                    className="edit ml-3"
                    onClick={() =>
                      updatePopUp(values, item?.strAccountingJournalCode)
                    }
                  >
                    <IDelete />
                  </span>
                  ...
                  >
                    <span className="pointer ml-3">
                      <i
                        onClick={() => {
                          reversePopUp(values, item?.strAccountingJournalCode);
                        }}
      ...
      <IViewModal show={open} onHide={() => setOpen(false)}>
        <CashJournalReportView
          ...
          clickRowData={{
            journalTypeId: row?.intAccountingJournalTypeId,
            strAccountingJournalCode: row?.strAccountingJournalCode,
          }}
        />
      </IViewModal>
    </div>
