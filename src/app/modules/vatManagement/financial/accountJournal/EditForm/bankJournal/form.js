...
import { generateAdviceNo, getNextBankCheque, getPartnerTypeDDL } from "../../helper";
  ...
  return (
    <>
      <Formik
        ...
        initialValues={{
          ...initData,
          transactionDate: location?.state?.dteTransaction ? dateFormatterForInput(location?.state?.dteTransaction) : _todayDate(),
        }}
                ...
                <div className="col-lg-8 pr-0">
                  ...
                  <div className="row">
                    <div style={{ paddingLeft: "8px" }} className="col-lg-12 p-0 pl-1 m-0">
                      <ReceiveAndPaymentsTable transaction={transaction} jorunalType={jorunalType} rowDto={rowDto} values={values} netAmount={netAmount} remover={remover} rowDtoHandler={rowDtoHandler} journalCode={journalCode}  />
                      <TransferTable jorunalType={jorunalType} values={values} journalCode={journalCode} />
                    </div>
                  </div>
                </div>
              </div>
