  ...
  return (
    <Switch>
      ...
      <ContentRoute
        ...
        component={
          accountJournalPermission?.isCreate ? CashJournalForm : NotPermitted
        }
      />
      <ContentRoute
        path="/mngVat/tax-financial/account-journalCreate/cashJournalEdit/:journalCode"
        component={
          accountJournalPermission?.isEdit ? CashJournalEditForm : NotPermitted
        }
      />
      <ContentRoute
        path="/mngVat/tax-financial/account-journalCreate/bankJournalCreate"
        component={
          accountJournalPermission?.isCreate ? BankJournalCreate : NotPermitted
        }
      />
      <ContentRoute
        path="/mngVat/tax-financial/account-journalCreate/bankJournalEdit/:journalCode"
        component={
          accountJournalPermission?.isEdit ? BankJournalEdit : NotPermitted
        }
      />
      <ContentRoute
        path="/mngVat/tax-financial/account-journalCreate/adjustmentJournalEdit/:journalCode"
        component={
          accountJournalPermission?.isEdit ? AdjustmentJournal : NotPermitted
        }
      />
      <ContentRoute
        path="/mngVat/tax-financial/account-journalCreate/adjustmentJournalCreate"
        component={
          accountJournalPermission?.isCreate ? AdjustmentJournal : NotPermitted
        }
      />
      <ContentRoute
        path="/mngVat/tax-financial/account-journalCreate"
        component={
          accountJournalPermission?.isView ? AccountJournal : NotPermitted
        }
      />
    </Switch>
  );
