    ...
    <div>
      <ICustomTable ths={ths}>
        {rowDto?.map((item, index) => {
          ...
          totalCredit += +item?.numCredit;
          totalDebit += +item?.numDebit;
          totalOpening += +item?.numOppening;
          return (
            <tr key={index}>
              <td>{index + 1}</td>
        ...
        <tr>
          ...
          <td className="text-right">
            <b>{_formatMoney(totalOpening)}</b>
          </td>
          <td className="text-right">
            <b>{_formatMoney(totalDebit)}</b>
          </td>
          <td className="text-right">
            <b>{_formatMoney(totalCredit)}</b>
          </td>
          <td className="text-right">
