...
export default function CustomDutyAdvancePayCreateEdit() {
  ...
  useEffect(() => {
    if (state?.intCustomDutyAdvancePaymentId) {
      getSingleData(
        `/imp/CustomDuty/GetCustomDutyAdvancePaymentById?intCustomDutyAdvancePaymentId=${state?.intCustomDutyAdvancePaymentId}`,
        (res) => {
          const data = {
            poLc: {
              value: res?.intPoId,
    ...
    getTypeDDL(`/imp/CustomDuty/GetAllAdvancePaymentType`, (res) => {
  ...
  const saveHandler = (values, cb) => {
    const payload = {
      intCustomDutyAdvancePaymentId: state?.intCustomDutyAdvancePaymentId
        ? state?.intCustomDutyAdvancePaymentId
        : 0,
    ...
    console.log('edit');
    customDutyAdvancePayCreateEdit(
      `/imp/CustomDuty/CreateNUpdateCustomDutyAdvancePayment`,
      payload,
      () => {},
      true
    );
  ...
  return (
    <Formik
      ...
      initialValues={
        state?.intCustomDutyAdvancePaymentId ? modifyData : initData
      }
