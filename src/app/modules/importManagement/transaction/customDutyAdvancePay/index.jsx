...
export default function CustomDutyAdvancePayment() {
  ...
  const getLandingData = (poId, shipmentId) => {
    getGridData(
      `/imp/CustomDuty/GetAllCustomDutyAdvancePayment?accountId=${profileData?.accountId}&businessUnitId=${selectedBusinessUnit?.value}&poId=${poId || 0}&shipmentId=${shipmentId || 0}&PageNo=${pageNo}&PageSize=${pageSize}`
    );
  };
  ...
  const setPositionHandler = (pageNo, pageSize, shipmentId, poId) => {
    getGridData(
      `/imp/CustomDuty/GetAllCustomDutyAdvancePayment?accountId=${profileData?.accountId}&businessUnitId=${selectedBusinessUnit?.value}&poId=${poId}&shipmentId=${shipmentId}&PageNo=${pageNo}&PageSize=${pageSize}`
    );
  };
              ...
              return (
                <div>
                  <button
                    ...
                    onClick={() => {
                      history.push(
                        '/managementImport/transaction/advance-payment-customs-duty/create'
                      );
                    }}
                  >
                    Create
                          ...
                          <span
                            ...
                            onClick={(e) =>
                              history.push({
                                ...
                                state: {
                                  poNo: item?.strPoNo,
                                  intCustomDutyAdvancePaymentId:
                                    item?.intCustomDutyAdvancePaymentId,
