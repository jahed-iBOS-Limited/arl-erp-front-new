...
export const getSingleData = async (customsDutyId, setter, setLoading) => {
  ...
  try {
    ...
    let modifyData = {
      ...
      assessmentValue: res?.data?.numAssesmentValueBdt || null,
      customDuty: res?.data?.numCustomDuty || null,
      regulatoryDuty: res?.data?.numRd || null,
      supplementaryDuty: res?.data?.numSd || null,
      vat: res?.data?.numVat || null,
      ait: res?.data?.numAit || null,
      advanceTradeVat: res?.data?.numAtv || null,
      psi: res?.data?.numPsi || null,
      at: res?.data?.numAt || null,
