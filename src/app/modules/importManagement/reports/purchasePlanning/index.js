                                    ...
                                    {tableData?.length > 0 &&
                                       tableData?.map((item, index) => (
                                          <tr key={index}>
                                             ...
                                             <td>
                                                {item?.numContractQty || 0}
                                             </td>
                                             <td>{item?.numPiQty || 0}</td>
                                             <td>
                                                {item?.strIncotermName || 'N/A'}
                                             </td>
                                             <td>{item?.numPriceFc || 0}</td>
                                             <td>{item?.numValueFc || 0}</td>
                                             <td className="text-center">
                                                {_dateFormatter(
                                                   item?.dteEstimatedLaycanDate
                                                ) || 'N/A'}
                                             </td>
                                             <td>{item?.dteEta || 'N/A'}</td>
                                             <td>
                                                {item?.intEstimatedSurviveDays ||
                                                   'N/A'}
                                             </td>
                                             <td className="text-center">
                                                {_dateFormatter(
                                             ...
                                             <td>
                                                {item?.strSupplierName || 'N/A'}
                                             </td>
                                             <td>
                                                {item?.strCountryOfOrigin ||
                                                   'N/A'}
                                             </td>
                                             <td>
                                                {item?.strLoadingPort || 'N/A'}
                                             </td>
                                             <td>{item?.numLcIssueQty || 0}</td>
                                             <td>
                                                {item?.numLcPendingQty || 0}
                                             </td>
                                          </tr>
                                       ))}
                                 </tbody>
