...
export default function WorkOrderForm({
  // It's a common component for both assetOrder and serviceRequest
  currentRowData,
  sbuName,
  plantName,
  warehouseName,
  ...
  const saveHandler = async (values, cb) => {
    ...
    if (values && profileData?.accountId && selectedBusinessUnit?.value) {
      ...
      const payload = {
        ...
        assetDescription: values?.assetNo?.label
          ? values?.assetNo?.label?.split('[')[0]
          : '',
        ...
        IsOthersInstallation:
          values?.picked === 'OthersInstallation' ? true : false,
