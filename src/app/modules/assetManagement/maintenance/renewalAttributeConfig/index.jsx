...
export default function ConfigRenewalAttribute() {
  ...
  const [vehicleTypeDDL, getVehicleTypeDDL, vehicleTypeDDLLoader] =
    useAxiosGet();
  ...
  const saveHandler = (values, cb) => {
    saveData(`/asset/Renewal/SaveRenewalAttributesValue`, rwoData, cb, true);
  };
  return (
    <Formik
    ...
    >
      {({
        ...
        <>
          {(renewalDDLLoader || vehicleTypeDDLLoader || rwoDataLoader) && (
            <Loading />
          )}
          <IForm
            isHiddenReset={true}
            isHiddenBack={true}
            title="Renewal Attribute Config"
              ...
              <div className="form-group  global-form row">
                ...
                <div className="col-lg-2">
                  <button
                    ...
                    onClick={() => {
                      getRwoData(
                        `/asset/Renewal/GetRenewalAttributesByType?renewalServiceId=${values?.renewalType?.value}&typeId=${values?.vehicleType?.value}`
                      );
                    }}
                  >
                    View
                      ...
                      <tr key={dataIndex}>
                        ...
                        <td>
                          <InputField
                            ...
                            onChange={(e) => {
                              let temp = [...rwoData];
                              temp[dataIndex].numAttributeValue =
                                +e.target.value;
                              setRowData(temp);
                            }}
                          />
