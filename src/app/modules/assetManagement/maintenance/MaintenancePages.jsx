...
export function MaintenancePages() {
  ...
  return (
    <Switch>
      <Redirect exact={true} from="/mngAsset" to="/mngAsset/maintenance" />

      {/* Work Order */}
      <ContentRoute
        from="/mngAsset/maintenance/workorder/edit/:id"
        component={
          workOrderPermission?.isEdit
      ...
      <ContentRoute
        ...
        component={
          workOrderPermission?.isView ? WorkOrderPage : NotPermittedPage
        }
      />
      ...
      <ContentRoute
        ...
        component={
          ASSET_Renewal_Registration?.isEdit
            ? MaintenanceServiceForm
            : NotPermittedPage
        }
      />
      <ContentRoute
        ...
        component={
          ASSET_Renewal_Registration?.isView
            ? RenewalRegLanding
            : NotPermittedPage
        }
      />
      <ContentRoute
        ...
        component={
          ASSET_Renewal_Registration_Approval?.isView
            ? RenewalRegApproval
            : NotPermittedPage
        }
      />
      <ContentRoute
        ...
        component={
          serviceRequestPermission?.isView ? ServiceRequest : NotPermittedPage
        }
      />
      <ContentRoute
        from="/mngAsset/maintenance/RenewalAttributeConfig"
        component={
          renewalAttributeConfig?.isView
            ? ConfigRenewalAttribute
            : NotPermittedPage
        }
      />
    </Switch>
