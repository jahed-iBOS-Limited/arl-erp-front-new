...
export function ReportsPages() {
  ...
  return (
    <Switch>
      ...
      />
      <ContentRoute from="/mngAsset/report/asset-List" component={AssetList} />
      <ContentRoute
      ...
      <ContentRoute
        ...
        component={
          assetDepreciation?.isView
            ? AssetDepreciationHistoryView
            : NotPermitted
        }
      />
      <ContentRoute
        ...
        component={
          assetDepreciation?.isView ? HistoryAssetDepreciation : NotPermitted
        }
      />
      <ContentRoute
        from="/mngAsset/report/RenewalExpireStatus"
        component={
          vehicleExpireReportPermission?.isView
            ? VehicleExpireStatus
            : NotPermitted
        }
      />
