            ...
            <Form>
              <div className="form-group  global-form row">
                ...
                <div className="col-lg-2">
                  <NewSelect
                    name="service"
                    options={[{ value: 'ALL', label: 'All' }, ...service]}
                ...
                <div className="col-lg-3 d-flex">
                  <button
                    onClick={() => {
                      getRowData(
                        `/asset/Asset/VehicleRenewalExpireDateWiseReport?BusinessUnitId=${selectedBusinessUnit?.value}&VehicleNo=${
                    ...
                    disabled={
                      !values?.service || !values?.fromDate || !values?.toDate
                    }
                  >
                    View
                  </button>
                            ...
                            return (
                              <tr key={idx}>
                                ...
                                <td className="text-center">
                                  {_dateFormatter(itm?.dteExpireDate)}
                                </td>
                                <td className="text-center">
                                  {_dateFormatter(itm?.dteNextRenewalDate)}
                                </td>
                              </tr>
                            );
                          })}
