...
const InventoryAdjust = () => {
  ...
  const paginationSearchHandler = (value, values) => {
    getTableData(
      `/wms/InventoryTransaction/GetInventoryAdjustmentSearchPagination?searchTerm=${
        value || ''
      }&accountId=${profileData?.accountId}&businessUnitId=${
        selectedBusinessUnit?.value
      }&warehouseId=${values?.warehouse?.value}&fromDate=${
        values?.fromDate
      }&toDate=${
        values?.toDate
  ...
  return (
    ...
    >
      {({
        ...
        <>
          {(tableDataLoader || plantDDLloader || wareHouseDDLloader) && (
            <Loading />
          )}
          <Form>
              ...
              <div className="col-lg-3">
                <NewSelect
                  ...
                  onChange={(valueOption) => {
                    ...
                    getWareHouseDDL(
                      `/wms/BusinessUnitPlant/GetOrganizationalUnitUserPermissionforWearhouse?UserId=${profileData?.userId}&AccId=${
