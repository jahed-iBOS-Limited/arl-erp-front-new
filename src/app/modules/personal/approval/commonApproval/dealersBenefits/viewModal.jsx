      ...
      <div className="row mb-3">
        <div className="col-md-6">
          <div className="card p-3">
            ...
            <p>
              <strong>Dealer Name:</strong> {data?.dealerBusinessName || ''}
            </p>
            <p>
              <strong>Address:</strong> {data?.dealerAddress || ''}
            </p>
            <p>
              <strong>Mobile No:</strong> {data?.mobileNo || ''}
            </p>
            <p>
              <strong>Present Depo:</strong> {data?.presentDepo || ''}
            </p>
            <p>
              <strong>Monthly Existing Business:</strong>{' '}
              {data?.monthlyExistingBusinessTotal || 0} MT
            </p>
            <p>
              <strong>Nearest Depot:</strong> {data?.ourNearestDepot || ''} (
              {data?.ourDepotDistancekm || 0} KM)
            </p>
          </div>
        </div>
        <div className="col-md-6">
          <div className="card p-3">
            ...
            <p>
              <strong>Zone:</strong> {data?.zoneName || ''}
            </p>
            <p>
              <strong>Region:</strong> {data?.regionName || ''}
            </p>
            <p>
              <strong>RSM Name:</strong> {data?.rsmname || ''}
            </p>
            <p>
              <strong>Party Status:</strong> {data?.partyStatus || ''}
            </p>
            <p>
              <strong>Credit Limit:</strong>{' '}
              {data?.presentCreditLimitAmount || 0} TK
            </p>
            <p>
              <strong>Credit Pay System:</strong> {data?.creditPaySys || ''}
            </p>
          </div>
        </div>
      </div>
        ...
        <tbody>
          ...
          <tr className="font-weight-bold">
            ...
            <td className="text-center">
              {total?.dealerPresentBenefit?.toFixed(2)}
            </td>
