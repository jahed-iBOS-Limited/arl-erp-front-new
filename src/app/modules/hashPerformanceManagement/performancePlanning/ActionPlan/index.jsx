...
export default function ActionPlan() {
  ...
  const [typeReferenceDDL, getTypeReferenceDDL, , setTypeReferenceDDL] =
    useAxiosGet();
  ...
  const saveHandler = (values) => {
    ...
    const payload = {
      ...
      typeReferenceId: rowData?.typeReferenceId || values?.typeReference?.value,
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-2">
                      <NewSelect
                        ...
                        errors={errors}
                        isDisabled={
                          !values?.year || !values?.quater || rowData?.row
                        }
                      />
                    </div>
                    <div className="col-lg-2">
                    ...
                    <div className="col-lg-2">
                      <InputField
                        ...
                        name="currentResult"
                        onChange={(e) => {
                          setFieldValue('currentResult', e.target.value);
                        }}
                    ...
                    <div className="col-lg-2">
                      <InputField
                        ...
                        name="desiredResult"
                        onChange={(e) => {
                          setFieldValue('desiredResult', e.target.value);
                        }}
                        disabled={!values?.year || !values?.quater}
                      />
                    </div>
