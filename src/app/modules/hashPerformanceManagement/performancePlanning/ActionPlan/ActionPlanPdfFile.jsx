    ...
    <div className="mt-5">
      ...
      <div className="row">
        ...
        <div className="col-lg-3">
          ...
          <div>
            <strong>Quarter</strong>: <span>{rowData?.quarter || ''}</span>
          </div>
        </div>
      </div>
        ...
        {rowData?.row?.map((item, index) => {
          return (
            <tr key={index}>
              ...
              <td>{item.activity}</td>
              <td className="text-center">{_dateFormatter(item.stardDate)}</td>
              <td className="text-center">{_dateFormatter(item.endDate)}</td>
            </tr>
          );
        })}
      </table>
