...
export default function WorkPlanLanding() {
  const { employeeId, userName, userId, designationId, defaultBusinessUnit } =
              ...
              <CardHeader title="Work Plan">
                <CardHeaderToolbar>
                  ...
                  <button
                    type="button"
                    style={{
                      cursor: planList?.row?.length < 1 ? 'no-drop' : 'pointer',
                    }}
                    className={`btn btn-primary mr-2`}
                    disabled={planList?.row?.length > 0 ? false : true}
                    onClick={() => {
                      pdfExport('Work plan');
                    }}
                  >
                ...
                <div className="form-group row mb-4 global-form">
                  ...
                  <div className="col-sm-5 col-lg-3 d-flex justify-content-end align-items-center">
                    <button
                      ...
                      style={{
                        cursor:
                          planList?.row?.length < 1 ? 'no-drop' : 'pointer',
                      }}
                      className={`btn btn-primary mr-2`}
                      disabled={
                        (planList?.row?.length > 0 ? false : true) ||
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <InputField
                                ...
                                onChange={(e) => {
                                  ...
                                  data[index].activity = e.target.value;
                                  setPlanList({
                                    ...planList,
                                    row: data,
                                  });
                            ...
                            <td style={{ minWidth: '150px' }}>
                              <NewSelect
                                ...
                                onChange={(valueOption) => {
                                  let data = planList?.row?.map((itm, idx) => {
                                    if (idx === index) {
                                      itm.frequencyId = valueOption?.value;
                                      itm.frequency = valueOption?.label;
                                    }
                                    return itm;
                                  });
                                  setPlanList({
                            ...
                            <td style={{ minWidth: '150px' }}>
                              <NewSelect
                                ...
                                onChange={(valueOption) => {
                                  let data = planList?.row?.map((itm, idx) => {
                                    if (idx === index) {
                                      itm.priorityId = valueOption?.value;
                                      itm.priority = valueOption?.label;
                                    }
                                    return itm;
                                  });
                                  setPlanList({
                            ...
                            <td>
                              <InputField
                                ...
                                onChange={(e) => {
                                  let data = [...planList.row];
                                  data[index].comments = e.target.value;
                              ...
                              >
                                ...
                                {showRemoveRowIcon ? (
                                  <span
                                    ...
                                    onClick={() => {
                                      removeActivityFromPlanList(index);
                                    }}
                                  >
                                    <IClose />
                                  </span>
