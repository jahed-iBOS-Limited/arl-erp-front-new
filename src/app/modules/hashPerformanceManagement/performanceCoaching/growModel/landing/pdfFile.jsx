        ...
        <Table className="global-table">
          ...
          <tr>
            <td className="p-2">
              ...
              <br />
              <span>
                What’s happening now in terms of the goal?How far am I away from
                the goal?
              </span>
            </td>
            <td>
          ...
          <tr>
            <td className="p-2">
              ...
              <br />
              <span>
                What is standing in the way –Me? Other people?Lack of skills,
                knowledge, expertise? Physical environment?
              </span>
            </td>
            <td>
              <span className="p-2">{pdfData?.singleData?.obstacles}</span>
            </td>
          </tr>
          <tr>
            <td className="p-2">
          ...
          <tr>
            ...
            <td>
              <span className="p-2">{pdfData?.singleData?.wayForward}</span>
            </td>
          </tr>
        </Table>
      </div>
