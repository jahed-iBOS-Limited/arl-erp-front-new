...
import ProductMainIndex from './product/productMainIndex';
import CostElementMainIndex from './costElement/costElementMainIndex';
...
function CostingPricingModel() {
  ...
  const [costingConfiguration, setCostingConfiguration] =
