...
export default function RevenueCenter() {
  ...
  const setPositionHandler = (pageNo, pageSize) => {
    getTableData(`/costmgmt/Revenue/GetRevenueCenterLandingPaging?accountId=${profileData?.accountId
      }&businessUnitId=${selectedBusinessUnit?.value
      }&status=true&pageNo=${pageNo}&pageSize=${pageSize}&viewOrder=desc`)
  };
  useEffect(() => {
    getTableData(`/costmgmt/Revenue/GetRevenueCenterLandingPaging?accountId=${profileData?.accountId
      }&businessUnitId=${selectedBusinessUnit?.value
              ...
              return (
                <div>
                  <button
                    ...
                    onClick={() => {
                      history.push("/internal-control/revenuecenter/revenue-center/create");
                    }}
                  >
                    Create
                  </button>
                            ...
                            <tr key={index}>
                              ...
                              <td className="text-center">
                                <IEdit title="Edit" onClick={
                                  () => history.push(`/internal-control/revenuecenter/revenue-center/edit/${item?.revenueCenterId}`)
                                } />
                              </td>
                            </tr>
                          ))
