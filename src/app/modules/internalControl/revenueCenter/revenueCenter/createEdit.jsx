...
export default function RevenueCenterCreateEdit() {
  ...
  const saveHandler = (values, cb) => {
    ...
    if (id) {
      ...
      saveData(
        `/costmgmt/Revenue/CreateRevenueCenterInformation`,
        editPayload,
        cb,
        true
      );
  ...
  useEffect(() => {
    ...
    if (id) {
      getSingleData(
        `/costmgmt/Revenue/GetRevenueCenterById?Id=${id}`,
        (data) => {
          setModifyData({
    ...
    >
      {({
        ...
        <>
          ...
          <IForm
            title={id ? 'Edit Revenue Center' : 'Create Revenue Center'}
