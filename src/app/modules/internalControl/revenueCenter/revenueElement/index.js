...
export default function RevenueElement() {
    ...
    const setPositionHandler = (pageNo, pageSize) => {
        getTableData(`/costmgmt/Revenue/GetRevenueElementLandingPaging?accountId=${profileData?.accountId}&businessUnitId=${selectedBusinessUnit?.value}&status=true&pageNo=${pageNo}&pageSize=${pageSize}&viewOrder=desc`)
    };
    useEffect(() => {
        getTableData(`/costmgmt/Revenue/GetRevenueElementLandingPaging?accountId=${profileData?.accountId}&businessUnitId=${selectedBusinessUnit?.value}&status=true&pageNo=${pageNo}&pageSize=${pageSize}&viewOrder=desc`)
                            ...
                            return (
                                <div>
                                    <button
                                        ...
                                        onClick={() => {
                                            history.push("/internal-control/revenuecenter/revenue-element/create");
                                        }}
                                    >
                                        Create
                                    </button>
                                                        ...
                                                        <tr key={index}>
                                                            ...
                                                            <td className="text-center">
                                                                <IEdit title="Edit" onClick={
                                                                    () => history.push(`/internal-control/revenuecenter/revenue-element/edit/${item?.revenueElementId}`)
                                                                } />
                                                            </td>
                                                        </tr>
                                                    ))
