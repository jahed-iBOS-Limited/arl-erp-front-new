...
const ProjectedBalanceReport = ({ balanceReportData, values }) => {
  console.log("balanceReportData, values", balanceReportData, values)
          ...
          <div className="my-5">
            <table id="table-to-xlsx" className="w-full">
              ...
              <tr style={{ background: "#F2F2F2" }}>
                <td style={{ fontWeight: "bold" }}>Total Non-Current Assets</td>
                <td className="text-right">
                  {_formatMoney(
              ...
              <tr style={{ background: "#D8D8D8" }}>
                ...
                >
                  {_formatMoney(
                    balanceReportData?.currentassetsTotalPlanBalance ||
                      0 + balanceReportData.nonCurrentAssetsTotalPlanBalance ||
                      0
                  )}
                </td>
                <td
              ...
              <tr style={{ background: "#D8D8D8" }}>
                ...
                <td
                  ...
                  style={{ borderBottom: "3px double black" }}
                >
                  {_formatMoney(equityAndLiaTotalForBudget(balanceReportData))}
                </td>
                <td
                  className="text-right"
                  style={{ borderBottom: "3px double black" }}
