            ...
            <table className="table table-striped table-bordered mt-3">
              <thead>
                <tr style={{fontSize: "18px"}}>
                  ...
                  <th>Charge During <br />   The Period</th>
              ...
              <tbody>
                {rowData?.map((item, index) => (
                  <tr key={index}>
                    <td style={{ fontWeight: "bold" , textAlign: "left" , paddingLeft: "1px"}}>{item?.strGlName}</td>
                    <td style={{ fontWeight: "bold" ,textAlign:"end",  fontSize:"12px", width: "120px"}}>
                      {numberWithCommas(Math.round(item?.numOpening) || 0)}
                    </td>
                    <td style={{textAlign:"end", paddingRight:"3px", fontSize:"12px", width: "140px"}}>
                      {numberWithCommas(Math.round(item?.numAddition) || 0)}
                    </td>
                    <td style={{textAlign:"end", paddingRight:"3px", fontSize:"12px"}}>
                      {numberWithCommas(Math.round(item?.numAdjustment) || 0)}
                    </td>
                    <td style={{fontWeight: "bold" ,textAlign:"end" , paddingRight:"3px", fontSize:"12px", width: "120px"}}>
                    ...
                    <td style={{textAlign:"end", paddingRight:"3px", fontSize:"12px", width: "130px"}}>
                      {numberWithCommas(
                    ...
                    <td style={{  fontWeight: "bold" ,textAlign:"end", paddingRight:"3px", fontSize:"12px" }}>
                ...
                <tr>
                  ...
                  <td style={{textAlign:"end", paddingRight:"3px", fontSize:"14px", paddingLeft:"4px"}}>
                    <strong>
