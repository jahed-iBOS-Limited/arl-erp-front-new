...
export default function TenderSubmissionCreateEditForm() {
  ...
  const [godownDDL, getGodownDDL, getGodownDDLLoading, updateGodownDDL] =
    useAxiosGet();
  const [tenderDetails, getTenderDetails, getTenderDetailsDDLLoading] =
    useAxiosGet();
  // const [ghatDDL, getGhatDDL, getGhatDDLLoading] = useAxiosGet();
  const [motherVesselDDL, getMotherVesselDDL, getMotherVesselDDLLoading] =
    useAxiosGet();
