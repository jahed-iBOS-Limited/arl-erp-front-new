...
import { deleteStevedore } from "../helper";

const initData = { search: "" };

const headers = ["SL", "Stevedore Name", "Phone No", "Action"];

const StevedoreLanding = () => {
  ...
  const getData = (search, pageNo, pageSize) => {
    ...
    const url = `/wms/FertilizerOperation/GetLighterstevedorePagination?${SearchTerm}BusinessUnitId=${buId}&PageNo=${pageNo}&PageSize=${pageSize}`;
    getRowData(url);
  };
  ...
  const deleteHandler = (id) => {
    const objProps = {
      title: "Are You Sure?",
      message: "Are you sure you want to delete this stevedore?",
      yesAlertFunc: () => {
        deleteStevedore(id, setLoading, () => {
          getData("", pageNo, pageSize);
        });
      },
      noAlertFunc: () => {},
...
export default StevedoreLanding;
