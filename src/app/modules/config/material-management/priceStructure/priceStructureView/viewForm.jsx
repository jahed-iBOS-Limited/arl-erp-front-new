...
export default function ViewForm({ id }) {
  ...
  const getBusinessUnitById = async (id) => {
    const res = await Axios.get(
      `/item/PriceStructure/GetPriceStructureViewData?PriceStructureId=${id}`
    );
  ...
  const columns = [
    ...
    },
    {
      ...
      text: 'Is Manual',
      formatter: (cell, row) => (
        <input type="checkbox" disabled checked={row?.isMannual} />
      ),
    },
  ];
  return (
          ...
          <Row>
            <Col lg="4">
              <Form.Group controlId="strPriceStructureName">
                ...
                <Form.Control
                  value={headerDto.strPriceStructureName}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
            ...
            <Col lg="4">
              <Form.Group controlId="strPriceStructureCode">
                ...
                <Form.Control
                  value={headerDto.strPriceStructureCode}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
            ...
            <Col lg="4">
              <Form.Group controlId="priceStructureTypeName">
                ...
                <Form.Control
                  value={headerDto.priceStructureTypeName}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
