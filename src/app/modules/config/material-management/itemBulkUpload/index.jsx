                            ...
                            {data?.length > 0 &&
                              data?.map((item, index) => (
                                <tr key={index}>
                                  ...
                                  <td className="text-center">
                                    {item?.intItemCategoryId}
                                  </td>
                                  <td>{item?.strItemCategoryName}</td>
                                  <td className="text-center">
                                    {item?.intItemSubCategoryId}
                                  </td>
                                  ...
                                  <td className="text-center">
                                    {item?.intConvertedUOM}
                                  </td>
                                  <td>{item?.strConvertedUomName}</td>
                                  <td className="text-center">
                                    {item?.intInventoryLocationId}
                                  </td>
                                  <td className="text-center">
                                    {item?.intPurchaseOrganizationId}
                                  </td>
                                  <td className="text-center">
                                    {item?.numLotSize}
                                  </td>
                                  <td className="text-center">
                                    {item?.isMRP ? 'true' : 'false'}
                                  </td>
                                </tr>
                              ))}
                          </tbody>
