...
export default function QcItemConfigLanding() {
  ...
  //DDL
  const [itemTypeDDL, getItemTypeDDL, loadItemTypeDDL, setGetItemTypeDDL] =
    useAxiosGet();
  const [itemCategoryDDL, getItemCategoryDDL, , settItemCategoryDDL] =
    useAxiosGet();
  const [itemSubCategoryDDL, getItemSubCategoryDDL, , setItemSubCategoryDDL] =
    useAxiosGet();
  ...
  const getLandingDataHandler = (pageNo, pageSize, values, searchTerm) => {
    getLandingData(
      `/mes/QCTest/GetQCItemInformation?businessUnitId=${buId}&plantId=${values?.plant?.value}&itemTypeId=${values?.itemType?.value}&itemCategoryId=${values?.itemCategory?.value}&itemSubCategoryId=${values?.itemSubCategory?.value}&status=${values?.status?.label}&pageNo=${pageNo}&pageSize=${pageSize}&search=${searchTerm ? searchTerm : ''}`
    );
  };
  ...
  useEffect(() => {
    ...
    getLandingData(
      `/mes/QCTest/GetQCItemInformation?businessUnitId=${buId}&plantId=${initData?.plant?.value}&itemTypeId=${initData?.itemType?.value}&itemCategoryId=${initData?.itemCategory?.value}&itemSubCategoryId=${initData?.itemSubCategory?.value}&status=${initData?.status?.label}&pageNo=${pageNo}&pageSize=${pageSize}`
    );
  }, []);
  return (
    <Formik
              ...
              <div className="form-group  global-form row">
                ...
                <div className="col-lg-3">
                  <NewSelect
                    name="itemCategory"
                    options={
                      [{ value: 0, label: 'All' }, ...itemCategoryDDL] || []
                    }
                ...
                <div className="col-lg-3">
                  <NewSelect
                    ...
                    options={
                      [{ value: 0, label: 'All' }, ...itemSubCategoryDDL] || []
                    }
