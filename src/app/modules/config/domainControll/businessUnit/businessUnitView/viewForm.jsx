...
export default function ViewForm({ id }) {
  ...
  const getBusinessUnitById = async (id, accountId) => {
    const res = await Axios.get(
      `/domain/BusinessUnitDomain/GetBusinessunitDomainByID?AccountId=${accountId || 1}&BusinessUnitId=${id}`
    );
    ...
    if (status === 200) {
      ...
      const singleObject = {
        ...
        ...objGetBusinessUnitLanguageDTO,
        ...objGetBusinessUnitCurrencyDTO,
        languageName: objGetBusinessUnitLanguageDTO.languageName,
        currencyName: objGetBusinessUnitCurrencyDTO.currencyName,
      };
          ...
          <Row>
            ...
            <Col lg="4">
              <Form.Group controlId="businessUnitCode">
                ...
                <Form.Control
                  value={businessUnitData.businessUnitCode}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
            ...
            <Col lg="4">
              <Form.Group controlId="businessUnitAddress">
                ...
                <Form.Control
                  value={businessUnitData.businessUnitAddress}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
          ...
          <Row>
            <Col lg="4">
              <Form.Group controlId="businessUnitLanguage">
                ...
                <Form.Control
                  value={businessUnitData.languageName}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
            ...
            <Col lg="4">
              <Form.Group controlId="businessUnitCurrency">
                ...
                <Form.Control
                  value={businessUnitData.currencyName}
                  type="text"
                  disabled
                  placeholder="Loading..."
                />
