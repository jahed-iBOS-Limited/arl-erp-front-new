...
export function getGridData(accId, buId, pageNo, pageSize) {
  return axios.get(
    `/domain/CodeGenerate/GetCodeGeneratePasignation?AccountId=${accId}&BusinessUnitId=${buId}&viewOrder=desc&PageNo=${pageNo}&PageSize=${pageSize}`
  );
}
...
export function getDataById(id) {
  return axios.get(
    `/domain/CodeGenerate/GetCodeGenerateById?CodeGenerateId=${id}`
  );
}
