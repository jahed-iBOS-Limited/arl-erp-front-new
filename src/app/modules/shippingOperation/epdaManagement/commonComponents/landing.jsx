...
const initData = {};
export default function CommonLoadAndDischargePortLanding({ featureName }) {
    ...
    const getLandingData = (values, pageNo, pageSize, searchValue = '') => {
        ...
        let controllerName = featureName === "Load Port" ? "GetEpdaAndPortInfoLanding" : featureName === "Discharge Port" ? "GetFromEpdaAndDischargePortInfoLanding" : ""

        getGridData(
            `${imarineBaseUrl}/domain/VesselNomination/${controllerName}?BusinessUnitId=${0}&FromDate=${values?.fromDate || _previousDate()
            }&ToDate=${values?.toDate || _todayDate()}&pageNumber=${pageNo || 1
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={(e) => {
                                                                ...
                                                                IConfirmModal({
                                                                    ...
                                                                    yesAlertFunc: () => {
                                                                        let apiUrl = featureName === "Load Port" ? `${imarineBaseUrl}/domain/VesselNomination/SetSelectedEpdaAgent?VesselNominationId=${item?.intVesselNominationId}&EpdaAndPortInfoId=${item?.intEpdaAndPortInfoId}&AgentName=${item?.strName}&AgentEmail=${item?.strEmail}` : featureName === "Discharge Port" ? `${imarineBaseUrl}/domain/VesselNomination/SetSelectedEpdaDischargePortAgent?VesselNominationId=${item?.intVesselNominationId}&EpdaDischargePortId=${item?.intEpdaLoadPortInfoId}&AgentName=${item?.strName}&AgentEmail=${item?.strEmail}` : ""
                                                                        onSelectHandler(
                                                                            apiUrl,
                                                                            null,
                                                                            () => {
