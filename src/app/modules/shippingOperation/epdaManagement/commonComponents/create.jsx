...
export default function CommonLoadAndDischargePortCreate({ featureName }) {
    const {
    ...
    const saveHandler = (values, cb) => {
        ...
        let apiEndPoint = featureName === "Load Port" ? "CreateEpdaAndPortInfo" : "CreateFromEpdaAndDischargePortInfo";

        onSave(
            `${imarineBaseUrl}/domain/VesselNomination/${apiEndPoint}`,
            payload,
            cb,
            true,
        );
        ...
        >
            {({
                ...
                <>
                    ...
                    <IForm
                        title={`Create EDPA ${featureName} Info `}
                        isHiddenReset
                        isHiddenBack
                        isHiddenSave
                        renderProps={() => {
