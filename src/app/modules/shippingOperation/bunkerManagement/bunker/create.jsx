...
export default function BunkerManagementCreate() {
  ...
  const [vesselMasterData, GetVesselMasterData, vesselMasterDataLoading] =
    useAxiosGet();
            ...
            <div className="form-group  global-form row">
              ...
              <div className="col-lg-3">
                <InputField
                  ...
                  type="number"
                  onChange={(e) => {
                    setFieldValue('numDepatureDraftForward', e.target.value);
                  }}
                  errors={errors}
                />
              </div>
              <div className="col-lg-3">
                <InputField
                  ...
                  type="number"
                  onChange={(e) => {
                    setFieldValue('numDepatureDraftAft', e.target.value);
                  }}
                  errors={errors}
                />
              </div>
