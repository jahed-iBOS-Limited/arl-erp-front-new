...
export default function CommonLoadAndDischargePortDocument({ fetureName }) {
    ...
    const getLandingData = (values, pageNo, pageSize) => {
        ...
        const apiName = fetureName === "Load Port" ? "DepartureDocumentsLoadPortLanding" : "DepartureDocumentsDischargePortLanding"

        getGridData(
            `${imarineBaseUrl}/domain/VesselNomination/${apiName}?${shipTypeSTR}${voyageTypeSTR}${vesselNameSTR}${voyageNoSTR}`,
        );
    };
    useEffect(() => {
        getLandingData();
