...
export default function CommonLoadAndDischargePortDocumentCreate({ fetureName }) {
    const {
    ...
    const saveHandler = (values, cb) => {
        ...
        let apiName = fetureName === "Load Port" ? "CreateDepartureDocumentsLoadPort" : "CreateDepartureDocumentsDischargePort";
