...
export const getReportId = (reportType) => {
  ...
  const SalesAnalysisAsPerReceivableReportId =
    '17af24d4-8e62-45ed-a4d7-08c91808b3c6';
  const CustomerSalesInvoiceReceiveInfoId =
    '17af24d4-8e62-45ed-a4d7-08c91808b3c6';
...
export const getParameterValues = (values, buId) => {
  ...
  const parameters =
    reportType === 1 || reportType === 2
      ? dayAndMonthBasis
      : reportType === 3
        ? salesAndRevenueCollection
        : reportType === 4
          ? customerSalesInvoiceReceiveInfo
          : [];
