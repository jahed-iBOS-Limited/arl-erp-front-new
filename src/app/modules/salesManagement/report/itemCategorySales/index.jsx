                        ...
                        <div className="col-lg-3">
                          <NewSelect
                            ...
                            onChange={(valueOption) => {
                              ...
                              if (valueOption) {
                                getWarehouseDDL(
                                  `wms/BusinessUnitPlant/GetOrganizationalUnitUserPermissionforWearhouse?UserId=${userId}&AccId=${accountId}&BusinessUnitId=${buId}&PlantId=${valueOption.value}&OrgUnitTypeId=8`
                                );
                              }
                            }}
                            placeholder="Plant"
