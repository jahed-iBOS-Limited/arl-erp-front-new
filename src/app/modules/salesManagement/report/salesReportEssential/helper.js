...
export const getCategoryBaseInfo = async ({
  ...
  const challanUrl = `/oms/SalesInformation/GetCategoryBaseChallan?intChannelId=${channelId}&intUnitid=${buId}&intshippingPointid=${shipPointId}&intRegionId=${regionId}&intAreaId=${areaId}&intTerritoryId=${territoryId}&intBusinessPartnerId=${partnerId}&intEmployeeid=${empId}&RATId=${ratId}&intLevelId=${levelId}&intpartid=${
    partId || 0
  }`;

  const salesOrderUrl = `/oms/SalesInformation/CategoryBaseSalesOrder?intChannelId=${channelId}&intUnitid=${buId}&intshippingPointid=${shipPointId}&intRegionId=${regionId}&intAreaId=${areaId}&intTerritoryId=${territoryId}&intBusinessPartnerId=${partnerId}&intEmployeeid=${empId}&RATId=${ratId}&intLevelId=${levelId}&intpartid=${
    partId || 0
  }`;
