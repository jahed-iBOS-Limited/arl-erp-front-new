                    ...
                    <table className="table table-striped table-bordered mt-3 bj-table bj-table-landing">
                      <thead>
                        <tr>
                          ...
                          <th style={{ fontSize: "10px" }}>
                            <div className="test-rotate">Order Required For Production Order </div>
                          </th>
                          <th style={{ fontSize: "10px" }}>
                            <div className="test-rotate">Stock Check on Shipment</div>
                          </th>
                          <th style={{ fontSize: "10px" }}>
                            <div className="test-rotate">Auto Sales Invoice</div>
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                                ...
                                <Field
                                  ...
                                  component={() => (
                                    <input
                                      type="checkbox"
                                      className="ml-2"
                                      value={item.inventory || values.inventory}
                                      checked={
                                ...
                                <Field
                                  ...
                                  component={() => (
                                    <input
                                      type="checkbox"
                                      className="ml-2"
                                      value={item.isSouseOnProductionOrder || values.isSouseOnProductionOrder}
                                      checked={
                                        item.isSouseOnProductionOrder || values.isSouseOnProductionOrder
                                      }
                                      name="isSouseOnProductionOrder"
                                      onChange={(e) => {
                                        itemSelectHandler(
