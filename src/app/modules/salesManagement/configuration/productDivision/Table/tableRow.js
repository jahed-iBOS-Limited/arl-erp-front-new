...
export function TableRow() {
  ...
  const gridData = useSelector((state) => {
    return state.productDivision?.gridData;
  }, shallowEqual);
  ...
  const columns = [
    ...
    {
      dataField: "productDivisionCode",
      text: "Product Division Code",
    },
    {
      dataField: "productDivisionName",
      text: "Product Division Name",
    },
    {
      dataField: "parentDivisionName",
      text: "Parent Product Division",
    },
    {
      dataField: "productDivisionType",
      text: "Product Division Type",
    },

    {
      dataField: "productDivisionId",
      text: "Actions",
      formatter: TableAction,
      formatExtraData: {
        openEditPage: uIProps.openEditPage,
        openViewDialog: uIProps.openViewDialog,
        key: "productDivisionId",
        isView: 0,
        isEdit: true,
      },
