...
const HologramPrint = ({ setShow, printData }) => {
    ...
    <>
      ...
      <div className="hologram_wrapper" ref={printRef}>
        ...
        <div className="d-flex justify-content-between">
          <div className="main_table">
                ...
                {rowList?.map((item, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="text-right">{item?.requestQuantity}</td>
            ...
            <table className="table mt-3">
              <tbody>
                <tr>
                  <td className="text-left">
                    Quantity in Words: {toWords.convert(totalQty.toFixed(0))}
                    <br />
          ...
          <div style={{ writingMode: "vertical-rl" }} className="text-center">
            <h1>Customer Copy</h1>
          </div>
        </div>
