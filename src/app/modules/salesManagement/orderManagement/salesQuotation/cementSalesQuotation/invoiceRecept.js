        ...
        <tbody>
          <div className="main_table">
            <div>
              ...
              <div className="mb-3">
                ...
                <p>
                  ...
                  in reference to your requirement and our discussion. In order
                  to take advantage of our corporate package please finds here
            ...
            <div className="mb-5">
              <div className="invoiceFooterInfo">
                <p>
                  <span>Mode of payment </span> Online /PO/Cheque, is to be
                  given in favor of <b>“Akij cement company limited”</b>.
                </p>
                <p>
                  <span>Credit Days </span>
                  {invoiceData?.[0]?.creditLimitDaysPropose} days from the date
                ...
                <p>
                  ...
                  Within 48 hours for Dhaka & 72 hours for outer Dhaka subject
                  to getting PO.
                </p>
                <p>
                  <span>Unloading </span>
                ...
                <p>
                  ...
                  {invoiceData?.[0]?.validityDays} days from the date price
                  offer issued.
                </p>
              </div>
            </div>
            ...
            <div className="note">
              <ul>
                ...
                <li>
                  a) In case of price revision, the work order quantity and
                  duration of delivery may not be considered.
                </li>
                <li>
                ...
                <li>
                  c) ACCL retains the ultimate discretion in respect of
                  delivery, time and price of any product.
                </li>
              </ul>
            </div>
            ...
            <div className="mb-5 mt-1">
              <p>
                ...
                regarding the quotation, please do not hesitate to contact our
                sales team at {contact} or {emailAddress}. We are always
                available to assist you and discuss any specific requirements
                you may need.
              </p>
            </div>
            <div className="mb-5">
          ...
          <div className="mt-5 pt-5 text-center">
            <p className="mt-5 pt-5">
              This is an automatically generated price quotation, no signature
              is required.
            </p>
          </div>
        </tbody>
