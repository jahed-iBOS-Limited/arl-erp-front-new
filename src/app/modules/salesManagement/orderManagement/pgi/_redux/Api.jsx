...
export function getGridData(accId, buId, shipPointId) {
  return axios.get(
    `/oms/PGI/GetPGIPasignation?AccountId=${accId}&BusinessUnitId=${buId}&ShippointId=${shipPointId}&viewOrder=desc&PageNo=1&PageSize=1000`
  );
}
...
export function getIsPGICheck(accId, buId) {
  return axios.get(
    `/oms/PGI/GetIsPGICheck?AccountId=${accId}&BusinessUnitId=${buId}`
  );
}
