  ...
  try {
    ...
    if (res.status === 200 && res.data) {
      ...
      const modifyGridData = {
        ...
        nationality: { value: data?.natinalityId, label: data.natinalityName },
        ...
        gender: { value: data?.genderId, label: data.gender },
        religion: { value: data?.religionId, label: data.religion },
        bloodGroup: { value: data?.bloodGroupId, label: data.bloodGroupName },
