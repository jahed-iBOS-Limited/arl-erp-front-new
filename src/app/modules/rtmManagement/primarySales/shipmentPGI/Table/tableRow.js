                      ...
                      {rowDto?.map((td, index) => (
                        <tr key={index}>
                          ...
                          <td className="text-right">
                            <div className="pr-2">{td?.shipmentCode}</div>
                          </td>
                            ...
                            <div className="d-flex justify-content-around">
                              <span className="view">
                                <IView
                                  clickHandler={() => {
                                    history.push(
                                      `/transport-management/shipmentmanagement/shipping/view/${td.shipmentId}/${td.shipmentCode}`
                                    );
                                  }}
                                />
                              </span>
                              <span
                                ...
                                onClick={() => {
                                  history.push(
                                    `/rtm-management/primarySale/shipment/edit/${td.shipmentId}`
                                  );
                                }}
                              >
                                <IEdit />
